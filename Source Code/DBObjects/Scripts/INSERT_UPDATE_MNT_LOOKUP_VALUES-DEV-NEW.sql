...
End
IF EXISTS (SELECT * FROM MNT_LOOKUP_VALUES WHERE LOOKUP_UNIQUE_ID=14935 AND IS_ACTIVE='Y')
BEGIN
	UPDATE MNT_LOOKUP_VALUES SET IS_ACTIVE='N' WHERE  LOOKUP_UNIQUE_ID = 14935
END
IF EXISTS (SELECT * FROM MNT_LOOKUP_VALUES WHERE LOOKUP_UNIQUE_ID=14934 AND IS_ACTIVE='Y')
BEGIN
	UPDATE MNT_LOOKUP_VALUES SET IS_ACTIVE='N' WHERE  LOOKUP_UNIQUE_ID = 14934
END