IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[PROC_GET_RISK_DETAILS]') AND type in (N'P', N'PC'))

DROP PROC dbo.[PROC_GET_RISK_DETAILS]
GO
...
CREATE PROC dbo.[PROC_GET_RISK_DETAILS]      
(      
@LOB_ID INT  ,
@CUSTOMER_ID INT  ,
@POLICY_ID  INT ,
