...
/****** Object:  StoredProcedure [dbo].[PROC_MIG_IL_POLICY_RISK_DISCOUNT_VALIDATE_DATA]    Script Date: 12/02/2011 16:37:04 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[PROC_MIG_IL_POLICY_RISK_DISCOUNT_VALIDATE_DATA]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[PROC_MIG_IL_POLICY_RISK_DISCOUNT_VALIDATE_DATA]
GO
 
/****** Object:  StoredProcedure [dbo].[PROC_MIG_IL_POLICY_RISK_DISCOUNT_VALIDATE_DATA]    Script Date: 12/02/2011 16:37:05 ******/
SET ANSI_NULLS ON
GO
...
CREATE PROCEDURE [dbo].[PROC_MIG_IL_POLICY_RISK_DISCOUNT_VALIDATE_DATA] 
