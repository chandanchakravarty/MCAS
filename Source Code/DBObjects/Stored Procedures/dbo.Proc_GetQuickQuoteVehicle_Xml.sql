 IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[Proc_GetQuickQuoteVehicle_Xml]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[Proc_GetQuickQuoteVehicle_Xml]
GO
...
GO
 ...
 /*----------------------------------------------------------    
Proc Name       : [Proc_GetQuickQuoteVehicle_Xml]    
...
CREATE PROC Proc_GetQuickQuoteVehicle_Xml    
(    
 @CUSTOMER_ID int,    
 @POLICY_ID int,    
...
--IF EXISTS(select * from TBL_TEMP_QUOTE_INFO)    
--BEGIN    
--PRINT 'TABLE EXISTS'  
-- DROP TABLE TBL_TEMP_QUOTE_INFO    
--END    
  
DROP TABLE TBL_TEMP_QUOTE_INFO  
    
SELECT * INTO TBL_TEMP_QUOTE_INFO FROM    
(      
SELECT PL.CUSTOMER_ID,PL.POLICY_ID,PL.POLICY_VERSION_ID,    
PL.APP_NUMBER,UPPER(CONVERT(VARCHAR(25),PL.POLICY_EFFECTIVE_DATE,106)) as POLICY_EFFECTIVE_DATE,    
UPPER(CONVERT(VARCHAR(25),PL.POLICY_EXPIRATION_DATE,106)) as POLICY_EXPIRATION_DATE,    
...
QD.REJECTED_DESC,QD.IS_DISEASE,QD.DISEASE_DESC,dbo.fun_FormatCurrency(CAST(QD.NAMED_DRIVER_AMT as decimal(25, 4)),'1') as NAMED_DRIVER_AMT,    
dbo.fun_FormatCurrency(CAST(QD.UNNAMED_DRIVER_AMT as decimal(25, 4)),'1') as UNNAMED_DRIVER_AMT,QD.FINAL_PREMIUM    
...
SET @XML = (Select * FROM TBL_TEMP_QUOTE_INFO    
FOR XML AUTO,ELEMENTS,ROOT('QUOTE'))    
