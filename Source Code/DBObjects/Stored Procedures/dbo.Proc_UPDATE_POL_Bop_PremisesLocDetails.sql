...
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[UPDATE_POL_BOP_PREMISES_LOC_DETAILS]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[UPDATE_POL_BOP_PREMISES_LOC_DETAILS]
GO
...
CREATE  PROCEDURE [dbo].[UPDATE_POL_BOP_PREMISES_LOC_DETAILS]      
(       
...
UPDATE [dbo].[POL_BOP_PREMISES_LOC_DETAILS]
	SET 
	   
		    DESC_BLDNG=@DESC_BLDNG
		    ,DESC_OPERTN 	           =@DESC_OPERTN 
           ,LST_ALL_OCCUP 	           =@LST_ALL_OCCUP 
           ,ANN_SALES 	           =@ANN_SALES 
           ,TOT_PAYROLL 	           =@TOT_PAYROLL 
           --,RATE_NUM 	           --=@RATE_NUM 
           --,RATE_GRP 	           --=@RATE_GRP 
           --,RATE_TER_NUM 	           --=@RATE_TER_NUM 
           ,PROT_CLS 	           =@PROT_CLS 
           ,IS_ALM_USED 	           =@IS_ALM_USED 
           ,IS_RES_SPACE 	           =@IS_RES_SPACE 
           ,RES_SPACE_SMK_DET 	           =@RES_SPACE_SMK_DET 
           ,RES_OCC 	           =@RES_OCC 
           ,FIRE_HYDRANT_DIST 	           =@FIRE_HYDRANT_DIST 
           ,FIRE_STATION_DIST 	           =@FIRE_STATION_DIST 
           ,FIRE_DIST_NAME 	           =@FIRE_DIST_NAME 
           ,FIRE_DIST_CODE 	           =@FIRE_DIST_CODE 
           ,BCEGS 	           =@BCEGS 
           ,CITY_LMT 	           =@CITY_LMT 
           ,SWIMMING_POOL 	           =@SWIMMING_POOL 
           ,PLAY_GROUND 	           =@PLAY_GROUND 
           ,BUILD_UNDER_CON 	           =@BUILD_UNDER_CON 
           ,BUILD_SHPNG_CENT 	           =@BUILD_SHPNG_CENT 
           ,BOILER 	           =@BOILER 
           ,MED_EQUIP 	           =@MED_EQUIP 
           ,ALARM_TYPE  	           =@ALARM_TYPE  
           ,ALARM_DESC 	           =@ALARM_DESC 
           ,SAFE_VAULT 	           =@SAFE_VAULT 
           ,PREMISE_ALARM 	           =@PREMISE_ALARM 
           ,CYL_DOOR_LOCK 	           =@CYL_DOOR_LOCK 
           ,SAFE_VAULT_LBL 	           =@SAFE_VAULT_LBL 
           ,SAFE_VAULT_CLASS 	           =@SAFE_VAULT_CLASS 
           ,SAFE_VAULT_MANUFAC 	           =@SAFE_VAULT_MANUFAC 
           ,MAX_CASH_PREM  	           =@MAX_CASH_PREM  
           ,MAX_CASH_MSG  	           =@MAX_CASH_MSG  
           ,MONEY_OVER_NIGHT  	           =@MONEY_OVER_NIGHT  
           ,FREQUENCY_DEPOSIT 	           =@FREQUENCY_DEPOSIT 
           ,SAFE_DOOR_CONST 	           =@SAFE_DOOR_CONST 
           ,GRADE 	           =@GRADE 
           ,OTH_PROTECTION 	           =@OTH_PROTECTION 
           ,RIGHT_EXP_DESC 	           =@RIGHT_EXP_DESC 
           ,RIGHT_EXP_DIST 	           =@RIGHT_EXP_DIST 
           ,LEFT_EXP_DESC 	           =@LEFT_EXP_DESC 
           ,LEFT_EXP_DIST 	           =@LEFT_EXP_DIST 
           ,FRONT_EXP_DESC 	           =@FRONT_EXP_DESC 
           ,FRONT_EXP_DIST 	           =@FRONT_EXP_DIST 
           ,REAR_EXP_DESC 	           =@REAR_EXP_DESC 
           ,REAR_EXP_DIST 	           =@REAR_EXP_DIST 
           ,COUNTY 						=@COUNTY 

 
	 WHERE LOC_DETAILS_ID=@LOC_DETAILS_ID
