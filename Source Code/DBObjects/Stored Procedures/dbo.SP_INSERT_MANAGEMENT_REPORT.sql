IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[SP_INSERT_MANAGEMENT_REPORT]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[SP_INSERT_MANAGEMENT_REPORT]
GO
...
CREATE PROC [dbo].[SP_INSERT_MANAGEMENT_REPORT]
(        
