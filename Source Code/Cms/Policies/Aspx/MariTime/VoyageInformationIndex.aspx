<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="VoyageInformationIndex.aspx.cs" Inherits="Cms.Policies.Aspx.MariTime.VoyageInformationIndex" %>
							...
							<table class="tableWidthHeader" cellSpacing="0" cellPadding="0" align="center" border="0">
                                ...
                                <tr>
									<td id="tdWorkflow" class="pageHeader" colspan="4">
										<webcontrol:WorkFlow id="myWorkFlow1" runat="server"></webcontrol:WorkFlow>
									</td>
								</tr>
								<!-- <input id="hide" type="hidden" name="ConVar"><span id="singleRec"></span> -->
								<tr>
									<TD class="pageHeader" id="tdClientTop" colSpan="4"><webcontrol:clienttop id="cltClientTop1" runat="server" width="100%"></webcontrol:clienttop></TD>
								</tr>
								...
								<tr>
									<td>
										<table class="tableWidthHeader" cellSpacing="0" cellPadding="0" align="center" border="0">
											<tr id="tabCtlRow">
												<td><webcontrol:tab id="TabCtl" runat="server" TabLength="150" TabTitles="Values" TabURLs="AddLookup.aspx?"></webcontrol:tab></td>
											</tr>
											<tr>
												<td>
