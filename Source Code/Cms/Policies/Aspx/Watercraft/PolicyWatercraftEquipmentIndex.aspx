<%@ Page language="c#" Codebehind="PolicyWatercraftEquipmentIndex.aspx.cs" AutoEventWireup="false" Inherits="Cms.Policies.Aspx.Watercrafts.PolicyWatercraftEquipmentIndex" %>
							...
							<tr>
								<td>					
									<table  class="tableWidthHeader" width="100%" cellSpacing="0" cellPadding="0" border="0" align="center">
										<tr id="tabCtlRow">
											<td >
												<webcontrol:Tab ID="TabCtl" runat="server" TabURLs="PolicyWatercraftAddEquipment.aspx?" TabTitles="Equipment Info" TabLength="175"></webcontrol:Tab>
											</td>
										</tr>
										<tr>
											<td>
