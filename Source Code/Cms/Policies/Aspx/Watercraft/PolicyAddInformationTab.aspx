...
<%@ Page language="c#" Codebehind="PolicyAddInformationTab.aspx.cs" AutoEventWireup="false" Inherits="Cms.Policies.Aspx.Watercrafts.PolicyAddInformationTab" %>
...
<HTML>
	<HEAD>
		...
		<script language="javascript">
			...
			function SetTab()
			{	
				Url="../../Aspx/PolicyShowDiscountAndSurcharges.aspx?CalledFrom=" + document.getElementById('hidCalledFrom').value    			
				//DrawTab(2,top.frames[1],'Discounts/Surcharges',Url); -- Done for Itrack Issue 5645 on 5 June 2009 	
				return;
			}		
		</script>
	</HEAD>
	<body MS_POSITIONING="GridLayout" onload="top.topframe.main1.mousein =false;findMouseIn();SetTab();showTab(0,0);showScroll();">
		<!-- To add bottom menu -->
		...
		<div id="bodyHeight" class="pageContent">
			<form id="Form1" method="post" runat="server">
					...
					<tr id="formTable" runat="server">
						<td>
							<table class="tableWidthHeader" cellSpacing="0" cellPadding="0" border="0" align="center">
								...
								<tr>
									<td>
										<webcontrol:Tab ID="TabCtl" runat="server" TabURLs="PolicyAddWatercraftGenInfo.aspx?" TabTitles="Underwriting Questions"
				...
				<input type="hidden" id="hidCalledFrom" name="hidCalledFrom" value="0" runat="server">
			</form>
		</div>
	</body>
</HTML>
