...
<%@ Page language="c#" Codebehind="PolicyAdditionalInterest.aspx.cs" AutoEventWireup="false" Inherits="Cms.Policies.Aspx.PolicyAdditionalInterest" ValidateRequest="false"%>
						...
						<TD>
							<TABLE class="tableWidthHeader" align="center" border="0">
								<TBODY>
									...
									<TR>
										<TD class="headerEffectSystemParams" width="18%" colSpan="4">Holder Details</TD>
									</TR>
									<tr>
										<TD class="midcolora" width="18%"><asp:label id="capHOLDER_ID" runat="server">Selected Holder/Interest</asp:label><span class="mandatory">*</span>
										</TD>
										<td class="midcolora"><asp:textbox id="txtHOLDER_ID" onblur="txtHOLDER_ID_OnBlur();" MaxLength="70" size="30" Runat="server"></asp:textbox><span class="labelfont" id="spnHOLDER_ID" runat="server"></span><IMG id="imgSelect" style="CURSOR: hand" alt="" src="../../../cmsweb/images/selecticon.gif"
												runat="server">
											<br>
										...
										<td class="midcolora" width="18%"><asp:Label ID="capRANK" Runat="server"></asp:Label><span class="mandatory">*</span></td>	
										<td class="midcolora" width="32%"><asp:TextBox ID="txtRANK" Runat="server" size="2" MaxLength="2"></asp:TextBox><br>
									...
									<TR>
										<TD class="midcolora" width="18%"><asp:label id="capHOLDER_ADD1" runat="server">Holder Address11</asp:label><SPAN class="mandatory">*</SPAN></TD>
										<TD class="midcolora" width="32%"><asp:textbox id="txtHOLDER_ADD1" runat="server" size="35" maxlength="70"></asp:textbox><br>
											<asp:requiredfieldvalidator id="rfvHOLDER_ADD1" runat="server" Display="Dynamic" ControlToValidate="txtHOLDER_ADD1"
												ErrorMessage="NAME can't be blank."></asp:requiredfieldvalidator></TD>
										<TD class="midcolora" width="18%"><asp:label id="capHOLDER_ADD2" runat="server">Holder Address222</asp:label></TD>
										<TD class="midcolora" width="32%"><asp:textbox id="txtHOLDER_ADD2" runat="server" size="35" maxlength="70"></asp:textbox></TD>
									</TR>
									<TR>
										<TD class="midcolora" width="18%"><asp:label id="capHOLDER_CITY" runat="server"></asp:label><SPAN class="mandatory">*</SPAN></TD>
										<TD class="midcolora" width="32%"><asp:textbox id="txtHOLDER_CITY" runat="server" size="35" maxlength="35"></asp:textbox><br>
											<asp:requiredfieldvalidator id="rfvHOLDER_CITY" runat="server" Display="Dynamic" ControlToValidate="txtHOLDER_CITY"
												ErrorMessage="NAME can't be blank."></asp:requiredfieldvalidator></TD>
										<TD class="midcolora" width="18%"><asp:label id="capHOLDER_COUNTRY" runat="server">Holder Countery1</asp:label></TD>
										<TD class="midcolora" width="32%"><asp:dropdownlist id="cmbHOLDER_COUNTRY" runat="server"></asp:dropdownlist><br>
										</TD>
									<TR>
										<TD class="midcolora" width="18%"><asp:label id="capHOLDER_STATE" runat="server">Holder City1</asp:label><%--<SPAN class="mandatory" >*</SPAN>--%></TD>
										<TD class="midcolora" width="32%"><asp:dropdownlist id="cmbHOLDER_STATE" runat="server" Enabled=False OnFocus="SelectComboIndex('cmbHOLDER_STATE')" ></asp:dropdownlist><br>
											<asp:requiredfieldvalidator id="rfvHOLDER_STATE" runat="server" Display="Dynamic" ControlToValidate="cmbHOLDER_STATE"
												ErrorMessage="NAME can't be blank." Enabled=false></asp:requiredfieldvalidator></TD>
										<TD class="midcolora" width="18%"><asp:label id="capHOLDER_ZIP" runat="server">Holder Zip11</asp:label><span class="mandatory">*</span></TD>
										<TD class="midcolora" width="32%"><asp:textbox id="txtHOLDER_ZIP" runat="server" size="13" maxlength="10"></asp:textbox>
									...
									<TR>
										<TD class="midcolora" width="18%"><asp:label id="capMEMO" runat="server">Memo</asp:label></TD>
										<TD class="midcolora" width="32%"><asp:textbox onkeypress="MaxLength(this,250)" id="txtMEMO" runat="server" size="200" maxlength="250"
										...
										<TD class="midcolora" width="18%"><asp:label id="capNATURE_OF_INTEREST" runat="server" >Nature Of Interest</asp:label><span class="mandatory">*</span></TD>
										<TD class="midcolora" width="32%">
											<P>
												...
												<br>
												<asp:RequiredFieldValidator id="rfvNATURE_OF_INTEREST" runat="server" Display="Dynamic" ControlToValidate="cmbNATURE_OF_INTEREST"></asp:RequiredFieldValidator></P>
										</TD>
									</TR>
									<tr>
										<TD class="midcolora" width="18%"><asp:label id="capLOAN_REF_NUMBER" runat="server">Loan/Reference No</asp:label></TD>
										<TD class="midcolora" width="32%"><asp:textbox id="txtLOAN_REF_NUMBER" runat="server" size="30" maxlength="75"></asp:textbox></TD>
										<TD class="midcolora" width="18%"><asp:label id="capBILL_MORTAGAGEE" runat="server">Bill this mortgagee</asp:label>
										</TD>
										<TD class="midcolora" width="32%"><asp:dropdownlist id="cmbBILL_MORTAGAGEE" onfocus="SelectComboIndex('cmbBILL_MORTAGAGEE')" runat="server" >											
											</asp:dropdownlist>
										</td>
									</tr>
									<TR>
										<TD class="midcolora" width="18%" colSpan="2"><cmsb:cmsbutton class="clsButton" id="btnReset" runat="server" CausesValidation="False" Text="Reset"></cmsb:cmsbutton>&nbsp;
