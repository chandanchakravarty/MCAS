<%@ Page language="c#" Codebehind="PolicyAutoGeneralInformationIFrame.aspx.cs" AutoEventWireup="false" Inherits="Cms.Policies.Aspx.PolicyAutoGeneralInformationIFrame" %>
...
<html>
	<head>
		...
		function SetTab()
		{
			...
			//DrawTab(2,top.frames[1],'Discount And Surcharge',Url); -- Done for Itrack Issue 5645 on 5 June 2009 	
			return;
		}			
		</script>
		</head>
	<body MS_POSITIONING="GridLayout" onload="top.topframe.main1.mousein =false;findMouseIn();SetTab();changeTab(0,0);showScroll();">
		<!-- To add bottom menu -->
					...
					<tr id="formTable" runat="server">
						<td>
							<table class="tableWidthHeader" cellSpacing="1" cellPadding="0" border="0" align="center">
								...
								<tr>
									<td>
										<webcontrol:Tab ID="TabCtl" runat="server" TabURLs="PolicyAutoGeneralInformation.aspx?" TabTitles="Underwriting Questions"
