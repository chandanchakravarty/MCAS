...
namespace Cms.Policies.Aspx
{
	...
	/// </summary>
	public class PolicyAdditionalInterest : Cms.Policies.policiesbase
	{
		...
		public void FillAdditionalInterestDetails()
		{
			...
			if(dtSet.Tables[0].Rows.Count>0)
			{
                ...
                //Commented and Added on 16-Feb-2012
                //cmbHOLDER_COUNTRY.SelectedValue	=	rdHolderDetails["HOLDER_COUNTRY"].ToString();
                if (cmbHOLDER_COUNTRY.Items.Count == 1)
                    cmbHOLDER_COUNTRY.SelectedIndex = 0;
                else if (cmbHOLDER_COUNTRY.Items.Count > 1)
                    cmbHOLDER_COUNTRY.SelectedIndex = 1;
		...
		private void Page_Load(object sender, System.EventArgs e)
		{
			...
			if( ! Page.IsPostBack)
			{
                ...
                hlkZipLookup.Visible = false; // Added by Ruchika Chauhan for Singapore Implementation
		...
		private void SetCaptions()
		{
			...
			capNATURE_OF_INTEREST.Text		=		objResourceMgr.GetString("cmbNATURE_OF_INTEREST");
		...
		private void SetErrorMessages()
		{
			...
			revHOLDER_ZIP.ValidationExpression				=	aRegExpZip;
