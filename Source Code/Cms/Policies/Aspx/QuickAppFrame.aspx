<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="QuickAppFrame.aspx.cs" Inherits="Cms.Policies.Aspx.QuickAppFrame" %>
...
<head>
    ...
    <title>Quick Application Frame</title>
        ...
        <tbody>
            <tr>
                <td colspan="2">
                    ...
                    StaticSubMenuIndent="10px" BackColor="White" StaticDisplayLevels="4" Orientation="Horizontal" StaticEnableDefaultPopOutImage="true" OnMenuItemDataBound="QuickAppMenu_MenuItemDataBound" >
                    ...
                    <asp:XmlDataSource ID="XmlDataSourceMenu" runat="server" DataFile="~/Policies/Aspx/QuickApp.xml"></asp:XmlDataSource>
                </td>
            </tr>
            <tr>
