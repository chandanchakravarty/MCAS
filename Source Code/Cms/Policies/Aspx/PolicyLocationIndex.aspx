...
<%@ Page language="c#" Codebehind="PolicyLocationIndex.aspx.cs" AutoEventWireup="false" Inherits="Cms.Policies.Aspx.PolicyLocationIndex" %>
...
<HTML>
	<HEAD>
		...
		function PriorLossTab()
		{
			...
			window.open('/cms/Application/priorloss/priorlossindex.aspx',null,"width=1000,height=1000,menubar=0,resizable=1");
		}
								...
								<tr>
									<td>
										<table class="tableWidthHeader" cellSpacing="0" cellPadding="0" border="0" align="center">
											<tr id="tabCtlRow">
												<td>
													<webcontrol:Tab ID="TabCtl" runat="server" TabURLs="AddLocation.aspx?" TabTitles="Location Details"
