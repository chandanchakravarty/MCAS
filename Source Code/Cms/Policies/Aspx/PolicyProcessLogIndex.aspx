...
<%@ Page language="c#" Codebehind="PolicyProcessLogIndex.aspx.cs" AutoEventWireup="false" Inherits="Cms.Policies.Aspx.PolicyProcessLogIndex" %>
					...
					<tr>
						<td>
							<table class="tableWidthHeader" cellSpacing="0" cellPadding="0" border="0" align="center">
								<tr id="tabCtlRow">
									<td>
										<webcontrol:Tab ID="TabCtl" runat="server" TabTitles="Process Log Detail" TabLength="150"></webcontrol:Tab>
									</td>
								</tr>
								<tr>
									<td>
