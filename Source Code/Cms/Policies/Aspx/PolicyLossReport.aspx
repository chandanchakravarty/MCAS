...
<%@ Page language="c#" Codebehind="PolicyLossReport.aspx.cs" AutoEventWireup="false" Inherits="Policies.Aspx.PolicyLossReport" %>
...
<HTML>
	<HEAD>
		...
		//Added By Sibin on 17 Nov 08 for Itrack Issue 5050
		...
		function FetchLoss()
		{
			...
			{
				document.getElementById('lblMessage').value='Fetching Loss Reports, please wait...';
	...
	<body oncontextmenu = "return false;" MS_POSITIONING="GridLayout" onload="init();" onunload="refershParent()"><!--Added onunload="refershParent()" By Sibin on 17 Nov 08 for Itrack Issue 5050-->
