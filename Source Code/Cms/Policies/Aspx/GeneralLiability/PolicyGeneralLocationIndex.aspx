<%@ Page language="c#" Codebehind="PolicyGeneralLocationIndex.aspx.cs" AutoEventWireup="false" Inherits="Policies.Aspx.GeneralLiability.PolicyGeneralLocationIndex" %>
					...
					<tr id="formTable" runat="server">
						<td>
							<table class="tableWidthHeader" cellSpacing="0" cellPadding="0" border="0" align="center">
								...
								<tr>
									<td>
										<webcontrol:Tab ID="TabCtl" runat="server" TabURLs="PolicyAddGeneralLocation.aspx"
											TabTitles="Location Details" TabLength="200"></webcontrol:Tab>											
									</td>
								</tr>
								<tr>
									<td>
