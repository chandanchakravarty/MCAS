<%@ Page language="c#" Codebehind="PolicyGeneralLiabilityTab.aspx.cs" AutoEventWireup="false" Inherits="Policies.Aspx.GeneralLiability.PolicyGeneralLiabilityTab" %>
					...
					<tr id="formTable" runat="server">
						<td>
							<table class="tableWidthHeader" cellSpacing="0" cellPadding="0" border="0" align="center">
								...
								<tr>
									<td>
										<webcontrol:Tab ID="TabCtl" runat="server" TabURLs="PolicyGeneralLiabilityDetails.aspx,PolicyGeneralLiabilityCoverages.aspx,/cms/cmsweb/Construction.html,../Automobile/PolicyAdditionalInterestIndex.aspx?CalledFrom=GEN"
											TabTitles="General Liability Details,Coverage Forms,Endorsements,Add Interest" TabLength="200"></webcontrol:Tab>											
									</td>
								</tr>
								<tr>
									<td>
