...
<%@ Page language="c#" Codebehind="PolicyGeneralLiabilityIndex.aspx.cs" AutoEventWireup="false" Inherits="Cms.Policies.Aspx.GeneralLiability.PolicyGeneralLiabilityIndex" %>
...
<HTML>
	...
	<body leftmargin="0" rightmargin="0" onload="setfirstTime();top.topframe.main1.mousein = false;" MS_POSITIONING="GridLayout">
				...
				<table width="100%" cellSpacing="0" cellPadding="0" border="0" align="center">
					...
					<tr>
									<td id="tdWorkflow" class="pageHeader" colspan="4">
										<webcontrol:WorkFlow id="myWorkFlow" runat="server" istop="false"></webcontrol:WorkFlow>
									</td>
								</tr>
					<tr>
						<td id="tdGridHolder">
					...
					<tr>
						<td>
							<table class="tableWidthHeader" cellSpacing="0" cellPadding="0" border="0" align="center">
								<tr id="tabCtlRow">
									<td>
										<webcontrol:Tab ID="TabCtl" runat="server" TabURLs="GeneralLiabilityDetails.aspx?" TabTitles="General Liability Details"
