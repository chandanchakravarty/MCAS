<%@ Page language="c#" Codebehind="PolicyOtherStructureIndex.aspx.cs" AutoEventWireup="false" Inherits="Policies.Aspx.Homeowner.OtherLocationsIndex" %>
								...
								<tr>
									<td>
										<table class ="tableWidthHeader" cellSpacing="0" cellPadding="0" border="0" align="center">
											<tr id="tabCtlRow">
												<td>
													<webcontrol:Tab ID="TabCtl" runat="server" TabURLs="PolicyAddOtherStructures.aspx?" TabTitles="Other Structures Detail"
