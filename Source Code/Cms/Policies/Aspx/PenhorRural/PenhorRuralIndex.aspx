<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PenhorRuralIndex.aspx.cs" Inherits="Cms.Policies.Aspx.PenhorRural.PenhorRuralIndex" %>
...
<body oncontextmenu = "return false;" onload="setfirstTime();top.topframe.main1.mousein = false;" scroll="no" MS_POSITIONING="GridLayout">		
		<!-- To add bottom menu -->
											...
											<tr>
												<td>
													<table class="tableeffect" cellpadding="0" cellspacing="0" border="0">
														<tr>
															<td>
																<iframe class="iframsMaxHeight" id="tabLayer" runat="server" src="" scrolling="no" frameborder="0"
																	width="100%"></iframe>
															</td>
														</tr>
													</table>
