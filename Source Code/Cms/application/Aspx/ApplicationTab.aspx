...
<%@ Page language="c#" Codebehind="ApplicationTab.aspx.cs" AutoEventWireup="false" Inherits="Cms.Application.Aspx.ApplicationTab" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>BRICS - Application Tab</title>
		...
		<script language="javascript">
			function showTab()
			{
				...
				if(document.getElementById("hidTabNumber").value=="1")
					changeTab(0,1);
				else if(document.getElementById("hidTabNumber").value=="2")
					changeTab(0,2);
				else
					changeTab(0,0);
			}
					...
					<tr id="formTable" runat="server">
						<td>
							<table class="tableWidthHeader" cellSpacing="0" cellPadding="0" border="0" align="center">
								...
								<tr>
									<td>
										<webcontrol:Tab ID="TabCtl" runat="server" TabURLs="GeneralInformation.aspx?" TabTitles="Application Information"
