...
<%@ Page language="c#" Codebehind="QuoteIndex.aspx.cs" AutoEventWireup="false" Inherits="Cms.Application.Aspx.Quote.QuoteIndex" %>
...
<HTML>
	...
	<body  oncontextmenu = "return false;" leftmargin="0" topmargin="0" onload="ApplyColor();ChangeColor();" MS_POSITIONING="GridLayout">
							...
							<tr>
								<td>					
									<table class ="tableWidthHeader"  cellSpacing="0" cellPadding="0" border="0" align="center">
										<tr id="tabCtlRow">
											<td>
												<webcontrol:Tab ID="TabCtl" runat="server" TabURLs="" TabTitles="Add Quote" TabLength="150"></webcontrol:Tab>
											</td>
										</tr>
										<tr>
											<td>
