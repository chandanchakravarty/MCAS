<%@ Page language="c#" Codebehind="ExpiryDatesIndex.aspx.cs" AutoEventWireup="false" Inherits="Cms.Application.PriorLoss.ExpiryDatesIndex" %>
								...
								<tr>
									<td>					
										<table class ="tableWidthHeader"  cellSpacing="0" cellPadding="0" border="0" align="center">
											<tr id="tabCtlRow">
												<td>
													<webcontrol:Tab ID="TabCtl" runat="server" TabURLs="AddExpiryDates.aspx?" TabTitles="Expiry Dates"	TabLength="150"></webcontrol:Tab>
												</td>
											</tr>
											<tr>
												<td>
