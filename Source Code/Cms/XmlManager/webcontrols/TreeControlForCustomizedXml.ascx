<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="TreeControlForCustomizedXml.ascx.cs"
    Inherits="Cms.webcontrols.TreeControlForCustomizedXml" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
<table width="100%">
