...
{
    public partial class PageXML : Cms.CmsWeb.cmsbase
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            trControlForPageXml.trvHandler += new webcontrols.TreeControlForPageXml.LinkClicked(TreeControlCustomized_trvHandler);
        }
