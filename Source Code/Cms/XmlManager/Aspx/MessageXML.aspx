<%@ Page Title="" Language="C#" MasterPageFile="~/XmlManager/Aspx/XmlMaster.Master"
    AutoEventWireup="true" CodeBehind="MessageXML.aspx.cs" Inherits="Cms.XmlManager.Aspx.MessageXML" %>

<%@ Register TagPrefix="webcontrol" TagName="Footer" Src="/cms/cmsweb/webcontrols/footer.ascx" %>
<%@ Register TagPrefix="webcontrol" TagName="Menu" Src="/cms/cmsweb/webcontrols/menu.ascx" %>
<%@ Register Src="../webcontrols/TreeControlForCustomizedXml.ascx" TagName="TreeControlForCustomizedXml"
    TagPrefix="uc1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div style="float: left; width: 35%">
        <uc1:TreeControlForCustomizedXml ID="trControlForCustomizedXml" runat="server" />
    </div>
