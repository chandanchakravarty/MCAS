...
<%@ Page language="c#" Codebehind="ClaimsCheck.aspx.cs" AutoEventWireup="false" Inherits="Reports.Aspx.ClaimsCheck" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>Claims Check Report</title>
		...
		function txtAMOUNT_From_Validate(objSource,objArgs)
		{
			...
			{	
				...
				*/
				...
				//C			
				//var url="CustomReport.aspx?PageName=ClaimsMonthlyCheck&FROMDATE="+ ExpirationStartDate + "&TODATE="+ ExpirationEndDate + "&CheckType=" + CheckType + "&CheckNo=" + CheckNo  + "&ClaimNo=" + ClaimNo +  "&Payee=" + Payee + "&FROMAMT=" + AmountFrom + "&TOAMT=" + AmountTo + "&CustomerID=" + CustomerID + "&PolicyID=" + PolicyID + "&VersionID=" + VersionID + "&AccountId=" + Account; 
				//CALLED_FROM Added For Itrack Issue #5497.
				var url="CustomReport.aspx?PageName=ClaimsMonthlyCheck&FROMDATE="+ ExpirationStartDate + "&TODATE="+ ExpirationEndDate + "&CheckType=9937&CheckNo=" + CheckNo  + "&ClaimNo=" + ClaimNo +  "&Payee=" + Payee + "&FROMAMT=" + AmountFrom + "&TOAMT=" + AmountTo +  "&AccountId=" + Account + "&FirstSortid=" + FirstSort + "&CALLED_FROM=CLM" + "&PolicyNumber=" + PolicyNumber; 

				//alert(url);
				var windowobj = window.open(url,'ClaimsMonthlyCheck','resizable=yes,scrollbar=yes,top=100,left=50')
				windowobj.focus();				
			}
		  ...
		  <DIV><webcontrol:menu id="bottomMenu" runat="server"></webcontrol:menu></DIV>	
			...
			<!-- To add bottom menu ends here --><asp:panel id="Panel1" Runat="server">
				<TABLE class="tableWidth" cellSpacing="1" cellPadding="0" width="100%" align="center" border="0">
					...
					<TR>
						<TD class="headereffectCenter" colSpan="4">Claims Check Report Selection Criteria</TD>
					</TR>
					<TR>
					...
					<TR>
						...
						<TD class="midcolora" width="32%">
							...
							<asp:CustomValidator id="csvAMOUNT" runat="server" ControlToValidate="txtFromRange" ErrorMessage="RegularExpressionValidator"
								Display="Dynamic" ClientValidationFunction="txtAMOUNT_From_Validate"></asp:CustomValidator></TD>
						<TD class="midcolora" width="18%">
							<asp:Label id="lblToRange" runat="server">Amount To</asp:Label></TD>
						<TD class="midcolora" width="32%">
							<asp:textbox id="txtToRange" runat="server" size="15"></asp:textbox><BR>
							<asp:CustomValidator id="csvAMOUNTto" runat="server" ControlToValidate="txtToRange" ErrorMessage="RegularExpressionValidator"
								Display="Dynamic" ClientValidationFunction="txtAMOUNT_To_Validate"></asp:CustomValidator></TD>
						</TD></TR>
					<TR>
						<TD class="midcolora" colSpan="1">
							<asp:label id="capPOLICY_ID" runat="server">Policy Number</asp:label></TD>
						<TD class="midcolora" colSpan="1">
							<asp:textbox id="txtPOLICY_ID" runat="server" size="15" ReadOnly="False" maxlength="10"></asp:textbox><IMG id="imgSelect" style="CURSOR: hand" onclick="OpenPolicyLookup();" alt="" src="../../cmsweb/images/selecticon.gif"
								runat="server">
						</TD>
						<TD class="midcolora" colSpan="1">
					...
					<TR>
						...
						<TD class="midcolora" colSpan="1">
							<asp:ListBox id="lstAccount" runat="server" SelectionMode="Multiple" Width="240px" Height="100px"></asp:ListBox></TD>
						<TD class="midcolora" colSpan="1">
							<asp:label id="lblFirstSort" runat="server">Sort</asp:label></TD>
						<TD class="midcolora" colSpan="1">
							<asp:DropDownList id="cmbFirstSort" runat="server" Width="100px" Height="100px">
								...
								<%--Commented For Itrack Issue #6475--%>
