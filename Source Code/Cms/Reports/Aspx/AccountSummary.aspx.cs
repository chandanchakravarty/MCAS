...
{
	public class AccountSummary : Cms.CmsWeb.cmsbase
	{
		...
		protected System.Web.UI.WebControls.Label lblPolicyNumber;
		//protected System.Web.UI.WebControls.ListBox lstPolicyNumber;
		...
		protected System.Web.UI.WebControls.Label lblUpdatedFrom;
		protected System.Web.UI.WebControls.DropDownList cmbUpdatedFrom;
		protected System.Web.UI.WebControls.Label lblAddress;
		protected System.Web.UI.WebControls.Label lblSourceTo;
		protected System.Web.UI.WebControls.TextBox txtSourceTo;
		protected System.Web.UI.WebControls.CustomValidator csvSourceTo;
		protected System.Web.UI.WebControls.Label lblSourceFrom;
		protected System.Web.UI.WebControls.TextBox txtSourceFrom;
		protected System.Web.UI.WebControls.CustomValidator csvSourceFrom;
		protected System.Web.UI.WebControls.CheckBox ChkAccountNumber;
		protected System.Web.UI.WebControls.Label lblAccountFrom;
		protected System.Web.UI.WebControls.TextBox txtAccountFrom;
		protected System.Web.UI.WebControls.CustomValidator csvAccountFrom;
		protected System.Web.UI.WebControls.Label lblAccountTo;
		protected System.Web.UI.WebControls.TextBox txtAccountTo;
		protected System.Web.UI.WebControls.Label lblOrderBy_1;
		protected System.Web.UI.WebControls.DropDownList cmbOrderBy_1;
		protected System.Web.UI.WebControls.Label lblOrderBy_2;
		protected System.Web.UI.WebControls.DropDownList cmbOrderBy_2;
		protected System.Web.UI.WebControls.Label lblOrderBy_3;
		protected System.Web.UI.WebControls.DropDownList cmbOrderBy_3;
		protected System.Web.UI.WebControls.Label lblOrderBy_4;
		protected System.Web.UI.WebControls.DropDownList cmbOrderBy_4;
		...
		protected System.Web.UI.WebControls.RequiredFieldValidator rfvSelOrderBy;
		protected System.Web.UI.WebControls.CustomValidator csvSelOrderBy;
		protected System.Web.UI.WebControls.CustomValidator csvAccountTo;
		protected Cms.CmsWeb.Controls.CmsButton btnAccSumm;
		protected Cms.CmsWeb.Controls.CmsButton btnCombTran;
		protected Cms.CmsWeb.Controls.CmsButton btnTran;
		...
		private void Page_Load(object sender, System.EventArgs e)
		{
			...
			base.ScreenId="353";
			btnAccSumm.CmsButtonClass                 =   Cms.CmsWeb.Controls.CmsButtonType.Read; 
			btnAccSumm.PermissionString				=	gstrSecurityXML;	

			btnCombTran.CmsButtonClass                 =   Cms.CmsWeb.Controls.CmsButtonType.Read; 
			btnCombTran.PermissionString				=	gstrSecurityXML;	

			btnTran.CmsButtonClass                 =   Cms.CmsWeb.Controls.CmsButtonType.Read; 
			btnTran.PermissionString				=	gstrSecurityXML;	

			btnAccSumm.Attributes.Add("onClick","ShowReport('S');return false;");
			btnCombTran.Attributes.Add("onClick","ShowReport('N');return false;");
			btnTran.Attributes.Add("onClick","ShowReport('T');return false;");
			...
			txtFromRange.Attributes.Add("onBlur","FormatAmount(document.getElementById('txtFromRange'));");
			txtToRange.Attributes.Add("onBlur","FormatAmount(document.getElementById('txtToRange'));");
			...
			csvAccountFrom.ErrorMessage	=  Cms.CmsWeb.ClsMessages.GetMessage(base.ScreenId,"163");
			csvAccountTo.ErrorMessage	=  Cms.CmsWeb.ClsMessages.GetMessage(base.ScreenId,"163");
			csvSourceFrom.ErrorMessage	=  Cms.CmsWeb.ClsMessages.GetMessage(base.ScreenId,"163");
			//csvSourceTo.ErrorMessage	=  Cms.CmsWeb.ClsMessages.GetMessage(base.ScreenId,"163");
			...
			if(!IsPostBack)
			{
				...
				{				
					...
					DataSet ds1 = objDataWrapper.ExecuteDataSet("Select ISNULL(CONVERT(VARCHAR,ACC_DISP_NUMBER)+' - '+ ACC_DESCRIPTION,'') as NAME ,Account_id as ID from act_gl_accounts order by Name");
					...
					*/
					//DataSet ds5 = objDataWrapper.ExecuteDataSet("Select isnull(company_name,'') as NAME ,VENDOR_ID as ID FROM mnt_vendor_list order by Name");
					DataSet ds5 = objDataWrapper.ExecuteDataSet("Select ISNull(COMPANY_NAME,'') + '-' + ISNULL(VENDOR_CODE,'') + '-' + isnull(VENDOR_ACC_NUMBER,'') as NAME ,VENDOR_ID as ID FROM mnt_vendor_list order by Name");
					...
					/*DataSet ds6 = objDataWrapper.ExecuteDataSet("select distinct isnull(policy_number,'') as Name ,isnull(policy_number,'') as ID from pol_customer_policy_list order by Name");
					lstPolicyNumber.DataSource = ds6.Tables[0];					
					lstPolicyNumber.DataTextField = "NAME";
					lstPolicyNumber.DataValueField = "ID";
					lstPolicyNumber.DataBind();
					this.lstPolicyNumber.Items.Insert(0,"All");
					this.lstPolicyNumber.SelectedIndex =0;*/
