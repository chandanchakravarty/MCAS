<%@ Page language="c#" Codebehind="Test.aspx.cs" AutoEventWireup="false" Inherits="Reports.Aspx.Test" %>
									...
									<td>
										<table class="tableWidthHeader" cellSpacing="0" cellPadding="0" border="0" align="center">
											<tr id="tabCtlRow" runat="server">
												<td>
													<webcontrol:Tab ID="TabCtl" runat="server" TabURLs="TestDetail.aspx?" TabTitles="Agency" TabLength="150"></webcontrol:Tab>
												</td>
											</tr>
											<tr>
												<td>
