...
<%@ Page language="c#" Codebehind="HolderList.aspx.cs" AutoEventWireup="false" Inherits="Reports.Aspx.HolderList" %>
...
<HTML>
	<HEAD>
		...
		{			
			...
			if (Customer!= ''&& Policy!= '')
			{			
				var url="CustomReport.aspx?PageName=HolderList&Customerid="+ Customer + "&Policyid="+ Policy; 
				var windowobj = window.open(url,'HolderList','resizable=yes,scrollbar=yes,top=100,left=50')
				windowobj.focus();
			}
		}		
