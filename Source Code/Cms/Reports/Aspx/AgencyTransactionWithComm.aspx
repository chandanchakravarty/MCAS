...
<%@ Page language="c#" Codebehind="AgencyTransactionWithComm.aspx.cs" AutoEventWireup="false" Inherits="Reports.Aspx.AgencyTransactionWithComm" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" > 

<html>
  <head>
    <title>AgencyTransactionWithComm</title>
  ...
  <body scroll = "yes" onload = "top.topframe.main1.mousein = false;findMouseIn();ApplyColor();BindEffectiveEvent();BindTransactionEvent();" MS_POSITIONING="GridLayout">
	
    <form id="Form1" method="post" runat="server">
	<div>
		<webcontrol:menu id="bottomMenu" runat="server"></webcontrol:menu>
	</div>
	<table class = "tablewidth" cellspacing = "1" cellpadding="0" align="center" width="100" border="0">
		<tr>
		...
		<tr>
			<td class="headereffectCenter" colspan="4">Agency Transaction Report With Commission</td>
		</tr>
		<tr>
		...
		<TR>
			...
			<TD class="midcolora" colSpan="2" width="20%"><asp:CheckBox id="chk_MonthYearEffectivedate" runat="server"></asp:CheckBox></TD>
		</TR>
		<TR id="trDate">
			<TD class="midcolora" width="18%">
				<asp:label id="lblExpirationStartDate" runat="server">From Effective Date</asp:label>
			</TD>						
			<TD class="midcolora" width="32%">
				<asp:TextBox id="txtExpirationStartDate" runat="server" size="12" MaxLength="10"></asp:TextBox>
				...
				<asp:regularexpressionvalidator id="revExpirationStartDate" Runat="server" ControlToValidate="txtExpirationStartDate" ErrorMessage="Please enter Date in 'mm/dd/yyyy' format." Display="Dynamic"></asp:regularexpressionvalidator>
				<asp:CompareValidator id="cmpExpirationDate" Runat="server" ControlToValidate="txtExpirationEndDate" ErrorMessage="End Date can't be less than Start Date." Display="Dynamic" Operator="GreaterThanEqual" Type="Date" ControlToCompare="txtExpirationStartDate"></asp:CompareValidator>
			</TD>						
			<TD class="midcolora" width="18%">
				<asp:label id="lblExpirationEndDate" runat="server">To Effective Date</asp:label>
			</TD>						
			<TD class="midcolora" width="32%">
				<asp:TextBox id="txtExpirationEndDate" runat="server" size="12" MaxLength="10"></asp:TextBox>
				...
				<asp:regularexpressionvalidator id="revExpirationEndDate" Runat="server" ControlToValidate="txtExpirationEndDate" ErrorMessage="Please enter Date in 'mm/dd/yyyy' format." Display="Dynamic"></asp:regularexpressionvalidator>
			</TD>
		</TR>					
							
		<TR id="trSpecificAgency">
			<TD class="midcolora" width="20%" colSpan="1">Effective Month</TD>
			<TD class="midcolora" width="20%" colSpan="1">
				<asp:dropdownlist id="cmbMonthEffectiveDate" onchange="ShowEffectiveDate();" Runat="server" >
			...
			<TD class="midcolora" colSpan="1" width ="20%">
				<asp:textbox id="txtEffectiveyear" onblur = "ShowEffectiveDate();" runat="server" size="5" MaxLength="4"></asp:textbox><BR>
				<asp:regularexpressionvalidator id="revEffectiveYear" runat="server" ControlToValidate="txtEffectiveyear" ErrorMessage="RegularExpressionValidator" Display="Dynamic"></asp:regularexpressionvalidator>
				<asp:rangevalidator id="rngEffectiveYEAR" Runat="server" ControlToValidate="txtEffectiveyear" Display="Dynamic" Type="Integer" MinimumValue="1950"></asp:rangevalidator>
				<asp:requiredfieldvalidator id="rfvEffectiveYear" runat="server" Display="Dynamic" ErrorMessage="Please enter Year."
				ControlToValidate="txtEffectiveyear"></asp:requiredfieldvalidator>
			</TD>
		</TR>
											
		<TR>
			<TD class="midcolora" colSpan="2" width ="20%"> Specific Month\Year Transaction Date </TD>
			<TD class="midcolora" colSpan="2" width="20%">
				<asp:CheckBox id="chk_MonthYearTransactiondate" runat="server"></asp:CheckBox>
			</TD>
		</TR>
		<TR id="trTransactionDate">
			...
			<TD class="midcolora" width="32%">
				<asp:TextBox id="txtTransactionStartDate" runat="server" size="12" MaxLength="10"></asp:TextBox>
				<asp:hyperlink id="hlkTransactionStartDate" runat="server" CssClass="HotSpot">								
				<ASP:IMAGE id="imgTransactionStartDate" runat="server" ImageUrl="/cms/cmsweb/Images/CalendarPicker.gif"></ASP:IMAGE>							
				</asp:hyperlink><BR>
				<asp:regularexpressionvalidator id="revTransactionStartDate" Runat="server" ControlToValidate="txtTransactionStartDate" ErrorMessage="Please enter Date in 'mm/dd/yyyy' format." Display="Dynamic"></asp:regularexpressionvalidator>
				<asp:CompareValidator id="cmpTransactionDate" Runat="server" ControlToValidate="txtTransactionEndDate" ErrorMessage="End Date can't be less than Start Date." Display="Dynamic" Operator="GreaterThanEqual" Type="Date" ControlToCompare="txtTransactionStartDate"></asp:CompareValidator>
			</TD>						
			<TD class="midcolora" width="18%">
				<asp:label id="lblTransactionEndDate" runat="server">To Transaction Date</asp:label>
			</TD>						
			<TD class="midcolora" width="32%">
				<asp:TextBox id="txtTransactionEndDate" runat="server" size="12" MaxLength="10"></asp:TextBox>
				<asp:hyperlink id="hlkTransactionEndDate" runat="server" CssClass="HotSpot">							
				<ASP:IMAGE id="imgTransactionEndDate" runat="server" ImageUrl="/cms/cmsweb/Images/CalendarPicker.gif"></ASP:IMAGE>							
				</asp:hyperlink><BR>
				<asp:regularexpressionvalidator id="revTransactionEndDate" Runat="server" ControlToValidate="txtTransactionEndDate" ErrorMessage="Please enter Date in 'mm/dd/yyyy' format." Display="Dynamic"></asp:regularexpressionvalidator>
			</TD>
		</TR>
		...
		<TR id="trSpecificAgencyTransaction">
			...
			<TD class="midcolora" colSpan="1" width="20%">
				<asp:dropdownlist id="cmbMonthTransactionDate" onchange="ShowTransactionDate();" Runat="server">
					<asp:ListItem></asp:ListItem>
					<asp:ListItem Value="01">January</asp:ListItem>
					<asp:ListItem Value="02">February</asp:ListItem>
					<asp:ListItem Value="03">March</asp:ListItem>
			...
			<TD class="midcolora" colSpan="1" width="20%"><asp:textbox id="txtTransactionyear" onblur = "ShowTransactionDate();" runat="server" size="5" MaxLength="4"></asp:textbox><BR>
				<asp:regularexpressionvalidator id="revTransactionYear" runat="server" ControlToValidate="txtTransactionyear" ErrorMessage="RegularExpressionValidator" Display="Dynamic"></asp:regularexpressionvalidator>
				<asp:rangevalidator id="rngTransactionYEAR" Runat="server" ControlToValidate="txtTransactionyear" Display="Dynamic" Type="Integer" MinimumValue="1950"></asp:rangevalidator>						
		...
		<TR>					  
			<TD class="midcolora" colSpan="1" width="20%">
				<asp:label id="capPOLICY_ID" runat="server">Policy Number</asp:label>
			</TD>
			<TD class="midcolora" colSpan="1" width="20%">
			...
			<TD class="midcolora" colSpan="1" width="20%">
				<asp:label id="capCUSTOMER_NAME" runat="server">Customer Name</asp:label>
			</TD>
			<TD class="midcolora" colSpan="1" width="20%">
		...
		<TR>
			<TD class="midcolora" colSpan="1" width="20%">
				<asp:label id="lblOrderBy" runat="server">Order By</asp:label>
			</TD>
			<TD class="midcolora" colSpan="1" width="20%">
				<asp:ListBox id="lstOrderBy" runat="server" Height="65px" SelectionMode="Multiple" Width="150px" AutoPostBack="false">
					...
					<asp:ListItem Value="TRANSACTION_DESCRIPTION">Transaction Description</asp:ListItem>
				</asp:ListBox>
			</TD>
			<TD class="midcolora" vAlign="middle" colSpan="1" width="20%">&nbsp;
				<asp:Button id="btnSel" Runat="server" Text=">>"></asp:Button><BR><BR>&nbsp;<asp:Button id="btnDeSel" Runat="server" Text="<<"></asp:Button>
			</TD>
			<TD class="midcolora" colSpan="1" width="20%">
				<asp:ListBox id="lstSelOrderBy" onblur="funcValidateSelOrderBy" runat="server" Height="65px" SelectionMode="Multiple" Width="110px" AutoPostBack="False" onchange="funcValidateSelOrderBy"></asp:ListBox><br>
				<asp:customvalidator id="csvSelOrderBy" Runat="server" ControlToValidate="lstSelOrderBy" Display="Dynamic" ClientValidationFunction="funcValidateSelOrderBy" Enabled="False"></asp:customvalidator>
				<SPAN id="spnSelOrderBy" style="DISPLAY: none; COLOR: red">Please select Order By.</SPAN> 
			</TD>
		</TR>
								
		<TR>
			<TD class="midcolorc" colSpan="4">
				<cmsb:cmsbutton class="clsbutton" id="btnAgencyTranComm" Runat="server" Text="Agency Transaction Report With Commission"></cmsb:cmsbutton>
			</TD>
		</TR> 	
	</table>
