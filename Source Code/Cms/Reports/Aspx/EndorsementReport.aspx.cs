...
{
	public class EndorsementReport : Cms.CmsWeb.cmsbase
	{
		...
		protected Cms.CmsWeb.Controls.CmsButton btnAddPolicy;
		protected Cms.CmsWeb.Controls.CmsButton btnRemovePolicy;
		...
		private void Page_Load(object sender, System.EventArgs e)
		{
			...
			btnAddPolicy.CmsButtonClass = Cms.CmsWeb.Controls.CmsButtonType.Execute;
			btnAddPolicy.PermissionString = gstrSecurityXML;

			btnRemovePolicy.CmsButtonClass = Cms.CmsWeb.Controls.CmsButtonType.Execute;
			btnRemovePolicy.PermissionString = gstrSecurityXML;
			
			this.CheckBox1.Attributes.Add("onClick","javascript: ShowContact();");
			this.Checkbox2.Attributes.Add("onClick","javascript: ShowPolicy();");

			btnAddPolicy.Attributes.Add("onClick","AssignPolicies();return false;");
			btnRemovePolicy.Attributes.Add("onClick","UnAssignPolicies();return false;");
