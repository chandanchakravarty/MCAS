...
{
	/// <summary>
	/// Summary description for AgencyTransactionWithComm.
	/// </summary>
	public class AgencyTransactionWithComm : Cms.CmsWeb.cmsbase  //System.Web.UI.Page
	{
		...
		private void Page_Load(object sender, System.EventArgs e)
		{
			...
			btnAgencyTranComm.CmsButtonClass    =   Cms.CmsWeb.Controls.CmsButtonType.Execute; 
			...
			btnAgencyTranComm.Attributes.Add("onClick","ShowEffectiveDate();ShowTransactionDate();Page_ClientValidate();ShowReport();return false;");		
