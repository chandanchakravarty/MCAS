...
<%@ Page language="c#" Codebehind="LapsedPolicies.aspx.cs" AutoEventWireup="false" Inherits="Reports.Aspx.LapsedPolicies" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>Lapsed Policies Report</title>
		...
		<DIV><webcontrol:menu id="bottomMenu" runat="server"></webcontrol:menu></DIV>			
			...
			<!-- To add bottom menu ends here --><asp:panel id="Panel1" Runat="server">
				<TABLE class="tableWidth" cellSpacing="1" cellPadding="0" width="100%" align="center" border="0">
					...
					<TR>
						<TD class="headereffectCenter" colSpan="4">Lapsed Policies Report Selection 
							Criteria</TD>
					</TR>
					<TR>
