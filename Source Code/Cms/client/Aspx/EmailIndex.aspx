...
<%@ Page language="c#" Codebehind="EmailIndex.aspx.cs" AutoEventWireup="false" Inherits="Cms.Client.Aspx.EmailIndex" %>
...
<HTML>
	...
	#tabContent { POSITION: absolute; TOP: 160px }
		...
		{
			if(document.getElementById('cltClientTop_lblFullName')!=null && document.getElementById('cltClientTop_lblFullName')!='undefined')
				CustomerName = document.getElementById('cltClientTop_lblFullName').innerText;
		}
		</script>
	</HEAD>
	<body oncontextmenu="return false;" onload="setfirstTime();top.topframe.main1.mousein = false;findMouseIn();GetCustomerName();" MS_POSITIONING="GridLayout">
							...
							<table class="tableWidthHeader" cellSpacing="0" cellPadding="0" align="center" border="0">
								...
								<tr>
									<td>
										<table class="tableWidthHeader" cellSpacing="0" cellPadding="0" align="center" border="0">
											<tr id="tabCtlRow">
												<td><webcontrol:tab id="TabCtl" runat="server" TabLength="150" TabTitles="Email" TabURLs="Email.aspx?"></webcontrol:tab></td>
											</tr>
											<tr>
												<td>
