<%@ Page language="c#" Codebehind="FaxIndex.aspx.cs" AutoEventWireup="false" Inherits="Cms.Client.Aspx.FaxIndex" %>
							...
							<table class="tableWidthHeader" cellSpacing="0" cellPadding="0" align="center" border="0">
								...
								<tr>
									<td>
										<table class="tableWidthHeader" cellSpacing="0" cellPadding="0" align="center" border="0">
											<tr id="tabCtlRow">
												<td><webcontrol:tab id="TabCtl" runat="server" TabLength="150" TabTitles="Fax" TabURLs="Fax.aspx?"></webcontrol:tab></td>
											</tr>
											<tr>
												<td>
