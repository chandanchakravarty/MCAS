	  ...
	  <html>
		  <body style="font-size: small; font-family: Arial, Helvetica, sans-serif">
			  <xsl:for-each select="$XML">
				  <table style="font-family:Arial;font-size:12pt;" border="0" ID="Table1" width ="100%">
										  ...
										  <td style="font-family:Arial; font-size:12pt;">
											  <xsl:choose>
												  <xsl:when test="string(LOCATION_ID) = ../RISKS[$curPos -1]/LOCATION_ID">
													  <span style="font-weight:normal;font-family:Arial;display:none;font-size:12pt;">
												  ...
												  <xsl:otherwise >
													  ...
													  <span style="font-weight:normal;font-family:Arial;font-size:12pt;">
														  <xsl:text>LOCAL </xsl:text>
													  </span>
													  <xsl:for-each select="LOCATION_NUMBER">
