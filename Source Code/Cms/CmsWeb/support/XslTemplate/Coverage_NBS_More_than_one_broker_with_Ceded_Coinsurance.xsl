            ...
            <tbody>
              <xsl:for-each select="POLICY_DOCUMENTS">
                            ...
                            <xsl:for-each select="COVERAGES">
                              <xsl:for-each select="COVERAGE">
                                <tr>
                                  ...
                                  <td style="width:6%;vertical-align:top;" align="right">
                                    <span style="font-family:Arial;font-size:12pt">
                                  ...
                                  <xsl:choose >
                                    <xsl:when test="DEDUCTIBLE2_AMOUNT_TEXT=''">
                                      <td style="width:8%;vertical-align:top" align="left">
                                    ...
                                    <xsl:otherwise>
                                      <td colspan="2" style="width:41%;vertical-align:top" >
                                        <span style="font-family:Arial;vertical-align:bottom; font-size:12pt text-align:left; ">
                ...
                <table  id="ceded_table" style="dis"   border="0" width="100%"  >
                  <tbody>
                    <tr>
                      <td colspan="4"  style="font-family:Arial Narrow;font-size:12pt">
                    ...
                    <tr>
                      ...
                      <td id="CedededComissao"  style="width:30%;vertical-align:top;" align="right">
                        <span style="font-family:Arial Narrow; font-size:12pt; ">
                          <xsl:text>Comissão</xsl:text>
                        </span>
                      </td>
                    ...
                    <tr>
                      <td style="width:30%;vertical-align:top" align="left" >
                        <span style="font-family:Arial Narrow; font-size:12pt;">
                          <xsl:value-of select="COINSURANCE/COMPANY/SUSEP_NUM" />
                        </span>
                      </td>
                      &#160;&#160;
                      <td style="width:40%;vertical-align:top" align="left" nowrap ="nowrap">
                        <span style="font-family:Arial Narrow; font-size:12pt;">
                          <xsl:value-of select="COINSURANCE/COMPANY/REIN_COMAPANY_NAME" />
                        </span>
                      </td>
                      <td style="width:30%;vertical-align:top;" align="right" >
                        <span style="font-family:Arial Narrow; font-size:12pt;">
                          <xsl:value-of select="COINSURANCE/COMPANY/COINSURANCE_PERCENT" />
                        </span>
                      </td>
                      <td  id="feeCeded" style="width:30%;vertical-align:top" align="right" >
                        <span style="font-family:Arial Narrow; font-size:12pt;">
                          <xsl:value-of select="COINSURANCE/COMPANY/COINSURANCE_FEE" />
                        </span>
                      </td>
                    </tr>
                  </tbody>
