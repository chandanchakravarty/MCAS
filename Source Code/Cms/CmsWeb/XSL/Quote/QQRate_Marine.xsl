        ...
        <table border="0" cellSpacing='1' cellPadding='1' align="center" width='100%'>
          <tr class="midcolora" align="center">
            ...
            <td align="center" colspan="5">
              <b>
                <xsl:text>Marine Cargo Insurance Premium Calculation Summary</xsl:text>
              </b>
            </td>
          </tr>
          ...
          <tr class="midcolora">
            <td width="20%" align="left" >
              <xsl:text>Toatl Sum Insured</xsl:text>
            </td>
            <td width="20%">
              <xsl:text>&#160;</xsl:text>
            </td>
            ...
            <td align="right" width="35%">
              <xsl:value-of select="format-number((QUICKQUOTE/POLICY/SUM_INSURED),'###,###.00')"/>
            </td>
          </tr>
          <!--<tr class="midcolora">
            <td width="20%" align="left" >
          ...
          <tr class="midcolora">
            ...
            <td width="5%">S$</td>
            <td align="right" width="35%">
              <xsl:value-of select="format-number((QUICKQUOTE/POLICY/MARINE_RATE),'###,###.00')"/>
            </td>
          </tr>
          <tr>
          ...
          <tr class="midcolora" >
            ...
            <td align="right" width="35%">
              ...
              <xsl:value-of select="format-number((QUICKQUOTE/POLICY/CALCULATED_PREMIUM),'###,###.00')"/>
            </td>
          </tr>
          <tr class="midcolora">
            <td colspan="5">
