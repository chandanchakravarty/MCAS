...
<%@ Page language="c#" Codebehind="QuoteTab.aspx.cs" AutoEventWireup="false" Inherits="Cms.CmsWeb.aspx.QuoteTab" %>
								...
								<tr>
									<td>
										<table class="tableWidthHeader" cellSpacing="0" cellPadding="0" border="0" align="center">
											<tr id="tabCtlRow">
												<td>
													<webcontrol:Tab ID="TabCtl" runat="server" TabURLs="QuickQuoteList.aspx?" TabTitles="Quick Quote Info"
