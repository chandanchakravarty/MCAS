...
<%@ Page language="c#" Codebehind="PersonalDetailTab.aspx.cs" AutoEventWireup="false" Inherits="Cms.CmsWeb.aspx.PersonalDetailTab" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
  <HEAD>
    <title>PersonalDetailTab</title>
								...
								<tr>
									<td>
										<table class="tableWidthHeader" cellSpacing="0" cellPadding="0" border="0" align="center">
											<tr id="tabCtlRow">
												<td>
													<webcontrol:Tab ID="TabCtl" runat="server" TabURLs="QuickQuoteList.aspx?" TabTitles="Personal Particulars"
