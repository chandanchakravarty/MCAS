...
<%@ Page language="c#" Codebehind="TemplateList.aspx.cs" AutoEventWireup="false" Inherits="Cms.CmsWeb.DocumentMerge.TemplateList" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>ExpertServiceProvidersIndex</title>
		...
		function copy()
		{
			...
			if (strLocation != 'about:blank') 
			{
				if (strLocation.indexOf('TemplateInfo') > -1)
					top.frames[1].document.frames["tabLayer"].document.location = top.frames[1].document.frames["tabLayer"].document.location + "&MODE=COPY";
			}
		}
									...
									<td>
										<table class="tableWidthHeader" cellSpacing="0" cellPadding="0" border="0" align="center">
											<tr id="tabCtlRow" runat="server">
												<td>
													<webcontrol:Tab ID="TabCtl" runat="server" TabLength="175"></webcontrol:Tab>
												</td>
											</tr>
											<tr>
												<td>
