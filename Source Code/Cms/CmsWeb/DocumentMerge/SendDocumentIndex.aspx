<%@ Page language="c#" Codebehind="SendDocumentIndex.aspx.cs" AutoEventWireup="false" Inherits="Cms.CmsWeb.DocumentMerge.SendDocumentIndex" %>
...
<HTML>
	<HEAD>
		<title>Send Document Index</title>
							...
							<table class="tableWidthHeader" cellSpacing="0" cellPadding="0" align="center" border="0">
								...
								<tr>
									<td>
										<table class="tableWidthHeader" cellSpacing="0" cellPadding="0" align="center" border="0">
											<tr id="tabCtlRow">
												<td><webcontrol:tab id="TabCtl" runat="server" TabLength="150" TabTitles="Letters" TabURLs="SendDocument.aspx?"></webcontrol:tab></td>
											</tr>
											<tr>
												<td>
