<%@ Page language="c#" Codebehind="StatesIndex.aspx.cs" AutoEventWireup="false" Inherits="Cms.CmsWeb.Maintenance.StatesIndex" %>
									...
									<td>
										<table class="tableWidthHeader" cellSpacing="0" cellPadding="0" border="0" align="center">
											<tr id="tabCtlRow" runat="server">
												<td>
													<webcontrol:Tab ID="TabCtl" runat="server" TabURLs="AddStates.aspx?" TabTitles="State Details"
