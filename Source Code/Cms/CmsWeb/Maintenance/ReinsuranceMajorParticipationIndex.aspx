<%@ Page language="c#" Codebehind="ReinsuranceMajorParticipationIndex.aspx.cs" AutoEventWireup="false" Inherits="Cms.CmsWeb.Maintenance.ReinsuranceMajorParticipationIndex" %>
...
<html>
  <head>
    <title>ReinsuranceMajorParticipationIndex</title>
			...
			<table border="0" cellpadding="0" cellspacing="0" width="100%">
				<tr>
					<td>
								...
								<tr>
									<td>
										<table class="tableWidthHeader" cellSpacing="0" cellPadding="0" border="0" align="center">
											<tr id="tabCtlRow">
												<td>
													<webcontrol:Tab ID="TabCtl" runat="server" TabURLs="AddReinsuranceMajorPart.aspx" TabTitles="Major Participation"
						...
						<input type="hidden" name="hidlocQueryStr" id="hidlocQueryStr"> <input type="hidden" name="hidMode"> </FORM>
					</td>
				</tr>
			</table>
		</div>
