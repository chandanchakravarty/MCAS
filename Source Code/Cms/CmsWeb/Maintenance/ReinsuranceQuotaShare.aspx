<%@ Page language="c#" Codebehind="ReinsuranceQuotaShare.aspx.cs" AutoEventWireup="false" Inherits="Cms.CmsWeb.Maintenance.ReinsuranceQuotaShare" %>
...
<HTML>
  <HEAD>
		<title>ReinsuranceQuotaShare</title>
								...
								<tr>
									<td>
										<table class="tableWidthHeader" cellSpacing="0" cellPadding="0" border="0" align="center">
											<tr id="tabCtlRow">
												<td>
													<webcontrol:Tab ID="TabCtl" runat="server" TabURLs="AddReinsuranceQuotaShare.aspx" TabTitles="Pro-Rata/Quota Share"
