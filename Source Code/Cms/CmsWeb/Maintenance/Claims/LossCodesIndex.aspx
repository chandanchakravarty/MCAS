<%@ Page language="c#" Codebehind="LossCodesIndex.aspx.cs" AutoEventWireup="false" Inherits="Cms.CmsWeb.Maintenance.Claims.LossCodesIndex" %>
...
<HTML>
  <HEAD>
		...
		function openErrorIndex()
		{	
			window.open('../../../application/aspx/ErrorIndex.aspx');			
		}		
									...
									<td>
										<table class="tableWidthHeader" cellSpacing="0" cellPadding="0" border="0" align="center">
											<tr id="tabCtlRow" runat="server">
												<td>
													<webcontrol:Tab ID="TabCtl" runat="server" TabLength="100"></webcontrol:Tab>
												</td>
											</tr>
											<tr>
												<td>
