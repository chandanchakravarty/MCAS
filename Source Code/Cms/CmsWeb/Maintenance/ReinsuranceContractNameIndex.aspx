<%@ Page language="c#" Codebehind="ReinsuranceContractNameIndex.aspx.cs" AutoEventWireup="false" Inherits="Cms.CmsWeb.Maintenance.ReinsuranceContractNameIndex" %>
...
<html>
  <head>
    <title>ReinsuranceContractNameIndex</title>
 ...
 <body onload="setfirstTime();top.topframe.main1.mousein = false;findMouseIn();">		
		<!-- To add bottom menu -->
								...
								<tr>
									<td>
										<table class="tableWidthHeader" cellSpacing="0" cellPadding="0" border="0" align="center">
											<tr id="tabCtlRow">
												<td>
													<webcontrol:Tab ID="TabCtl" runat="server" TabURLs="AddReinsuranceContractName.aspx" TabTitles="Contract Name"
