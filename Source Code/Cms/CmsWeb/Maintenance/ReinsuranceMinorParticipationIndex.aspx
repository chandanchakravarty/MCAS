<%@ Page language="c#" Codebehind="ReinsuranceMinorParticipationIndex.aspx.cs" AutoEventWireup="false" Inherits="Cms.CmsWeb.Maintenance.ReinsuranceMinorParticipationIndex" %>
...
<html>
  <head>
    <title>ReinsuranceMinorParticipationIndex</title>
								...
								<tr>
									<td>
										<table class="tableWidthHeader" cellSpacing="0" cellPadding="0" border="0" align="center">
											<tr id="tabCtlRow">
												<td>
													<webcontrol:Tab ID="TabCtl" runat="server" TabURLs="AddReinsuranceMinorPart.aspx" TabTitles="Minor Participation"
