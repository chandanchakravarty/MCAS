<%@ Page language="c#" Codebehind="ReinsurancePremiumBuilderIndex.aspx.cs" AutoEventWireup="false" Inherits="Cms.CmsWeb.Maintenance.Reinsurance.ReinsurancePremiumBuilderIndex" %>
...
<HTML>
	<HEAD>
		<title>ReinsurancePremiumBuilderIndex</title>
	...
	<body oncontextmenu = "return false;" class="bodyBackGround" topmargin="0" leftmargin="0" onload="setfirstTime();top.topframe.main1.mousein = false;findMouseIn();">		
		<div id="bodyHeight" class="pageContent">
			<table class="tableWidthHeader" border="0" cellpadding="0" cellspacing="0" scrolling="no">
				<tr>
					<td>
								...
								<tr>
									<td>
										<table class="tableWidthHeader" cellSpacing="0" cellPadding="0" border="0" align="center"
											...
											<tr id="tabCtlRow">
												<td>
													<webcontrol:Tab ID="TabCtl" runat="server" TabURLs="AddReinsurancePremiumBuilder.aspx" TabTitles="Reinsurance Premium Builder"
