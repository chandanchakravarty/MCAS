...
<%@ Page language="c#" Codebehind="DepartmentIndex.aspx.cs" AutoEventWireup="false" Inherits="Cms.CmsWeb.Maintenance.DepartmentIndex" %>
								...
								<tr>
									<td>
										<table class ="tableWidthHeader" cellSpacing="0" cellPadding="0" border="0" align="center">
											<tr id="tabCtlRow">
												<td>
													<webcontrol:Tab ID="TabCtl" runat="server" TabURLs="AddDepartment.aspx?" TabTitles="Department"
