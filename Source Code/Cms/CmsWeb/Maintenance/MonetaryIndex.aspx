...
<%@ Page language="c#" Codebehind="MonetaryIndex.aspx.cs" AutoEventWireup="false" Inherits="Cms.CmsWeb.Maintenance.MonetaryIndex" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>MonetaryIndex</title>
								...
								<tr>
									<td>
										<table class ="tableWidthHeader" cellSpacing="0" cellPadding="0" border="0" align="center">
											<tr id="tabCtlRow">
												<td>
													<webcontrol:Tab ID="TabCtl" runat="server" TabURLs="AddMonetaryDetails.aspx?" TabTitles="Add Monetary Details" TabLength="150"></webcontrol:Tab>
												</td>
											</tr>
											<tr>
												<td>
