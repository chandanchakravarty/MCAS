<%@ Page language="c#" Codebehind="UserIndex.aspx.cs" AutoEventWireup="false" Inherits="Cms.CmsWeb.Maintenance.UserIndex" %>
...
#tabContent {
	...
	<body oncontextmenu = "return false;" onload="top.topframe.main1.mousein = false;Check();" MS_POSITIONING="GridLayout">		
							...
							<form id="indexForm" method="post" runat="server">
								...
								<tr>
									<td>
										<table class="tableWidthHeader" cellSpacing="0" cellPadding="0" align="center" border="0">
											<tr id="tabCtlRow">
												<td><webcontrol:tab id="TabCtl" runat="server"></webcontrol:tab></td>
											</tr>
											<tr>
												<td>
