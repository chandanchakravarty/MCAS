...
<%@ Page language="c#" Codebehind="MortgageIndex.aspx.cs" AutoEventWireup="false" Inherits="Cms.CmsWeb.Maintenance.MortgageIndex" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>DepartmentIndex</title>
								...
								<tr>
									<td>
										<table class ="tableWidthHeader" cellSpacing="0" cellPadding="0" border="0" align="center">
											<tr id="tabCtlRow">
												<td>
													<webcontrol:Tab ID="TabCtl" runat="server" TabURLs="AddMortgage.aspx?" TabTitles="Additional Interest" TabLength="150"></webcontrol:Tab>
												</td>
											</tr>
											<tr>
												<td>
