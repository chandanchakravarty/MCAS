<%@ Page language="c#" Codebehind="ReinsurerIndex.aspx.cs" AutoEventWireup="false" Inherits="Cms.CmsWeb.Maintenance.ReinsurerIndex" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" %>
					...
					<td>
						<table class="tableWidthHeader" cellSpacing="0" cellPadding="0" border="0" align="center">
							<form id="indexForm" method="post" runat="server">
								...
								<p align="center"><asp:Label ID="capMessage" Runat="server" Visible="False" 
                                        CssClass="errmsg" meta:resourcekey="capMessageResource1"></asp:Label></p>
								<tr>
									<td>
