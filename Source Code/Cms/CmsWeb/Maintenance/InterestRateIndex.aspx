<%@ Page Language="C#" AutoEventWireup="false" CodeBehind="InterestRateIndex.aspx.cs" Inherits="Cms.CmsWeb.Maintenance.InterestRateIndex" %>
				...
				<tr>
								...
								<tr>
									<td>
										<table class ="tableWidthHeader" cellSpacing="0" cellPadding="0" border="0" align="center">
											<tr id="tabCtlRow">
												<td>
													<webcontrol:Tab ID="TabCtl" runat="server" TabURLs="InterestRateDetail.aspx?" TabTitles="Interest Rate" TabLength="150"></webcontrol:Tab>
												</td>
											</tr>
											<tr>
												<td>
                    ...
                    <input type="hidden" name="hidTemplateID">
                     <input type="hidden" name="hidRowID">
                        ...
                        <input type="hidden" name="hidMode"></td>
				</tr>
			</table>
		</div>
    </form>
