<%@ Page language="c#" Codebehind="AddReinsuranceExcessLayer.aspx.cs" AutoEventWireup="false" validateRequest="false" Inherits="Cms.CmsWeb.Maintenance.AddReinsuranceExcessLayer" %>
<%@ Register TagPrefix="cmsb" NameSpace="Cms.CmsWeb.Controls" Assembly="CmsButton" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
  <HEAD>
		<title>AddReinsuranceExcessLayer</title>
		...
		<script language='javascript'>
			...
			{	
				...
				document.getElementById('txtLAYER_AMOUNT').focus();
				document.getElementById('txtLAYER_AMOUNT').value  = '';
				document.getElementById('txtUNDERLYING_AMOUNT').value  = '';
			...
			{
				document.getElementById('txtLAYER_AMOUNT').value		= formatCurrency(document.getElementById('txtLAYER_AMOUNT').value);	
				document.getElementById('txtUNDERLYING_AMOUNT').value	= formatCurrency(document.getElementById('txtUNDERLYING_AMOUNT').value);
	...
	<body leftMargin='0' topMargin='0' onload="populateXML();ApplyColor();formatCurrencyOnLoad();">
		<form id="MNT_REINSURANCE_EXCESSLAYER" method="post" runat="server">
						...
						<TBODY>
							...
							<tr>
								<td class="midcolora" width="18%">
									<asp:Label id ="capLAYER_AMOUNT" runat="server">Layer Amount</asp:Label><span class="mandatory">*</span>
								</td>
								<td class="midcolora" width="32%" colSpan="3">
									<asp:textbox id="txtLAYER_AMOUNT" runat="server" CssClass="INPUTCURRENCY" size="20" maxlength="9" onblur="this.value=formatAmount(this.value);">
									</asp:textbox><br>
									<asp:RequiredFieldValidator ID="rfvLAYER_AMOUNT" ControlToValidate="txtLAYER_AMOUNT" Runat="server" ErrorMessage="LAYER_AMOUNT can't be blank." Display="Dynamic"></asp:RequiredFieldValidator>
									<asp:regularexpressionvalidator id="revLAYER_AMOUNT" Display="Dynamic" ControlToValidate="txtLAYER_AMOUNT" Runat="server"></asp:regularexpressionvalidator>
								</td>
							</tr>
							<tr>
								<td class="midcolora" width="18%">
									<asp:Label id ="capUNDERLYING_AMOUNT" runat="server">Underlying Amount</asp:Label><span class="mandatory">*</span>
								</td>
								<td class="midcolora" width="32%" colSpan="3">
									<asp:textbox id="txtUNDERLYING_AMOUNT" runat="server" CssClass="INPUTCURRENCY" size="20" maxlength="9" onblur="this.value=formatAmount(this.value);">
									</asp:textbox><br>
									<asp:RequiredFieldValidator ID="rfvUNDERLYING_AMOUNT" ControlToValidate="txtUNDERLYING_AMOUNT" Runat="server" ErrorMessage="UNDERLYING_AMOUNT can't be blank." Display="Dynamic"></asp:RequiredFieldValidator>
									<asp:regularexpressionvalidator id="revUNDERLYING_AMOUNT" Display="Dynamic" ControlToValidate="txtUNDERLYING_AMOUNT" Runat="server"></asp:regularexpressionvalidator>
								</td>
							</tr>
							<tr>
								<td class="midcolora" width="18%">
							...
							<tr>
								...
								<td class="midcolora" width="32%" colSpan="3">
									<asp:textbox id="txtCEDING_COMMISSION" runat="server" CssClass="INPUTCURRENCY" size="10" maxlength="5" onblur="this.value=formatAmount(this.value);"></asp:textbox><br>
