<%@ Page language="c#" Codebehind="UserTypeIndex.aspx.cs" AutoEventWireup="false" Inherits="Cms.CmsWeb.Maintenance.UserTypeIndex" %>
								...
								<tr>
									<td>
										<table class ="tableWidthHeader" cellSpacing="0" cellPadding="0" border="0" align="center">
											<tr id="tabCtlRow">
												<td>
													<webcontrol:Tab ID="TabCtl" runat="server" TabURLs="AddUserType.aspx?" TabTitles="User Type" TabLength="150"></webcontrol:Tab>
												</td>
											</tr>
											<tr>
												<td>
