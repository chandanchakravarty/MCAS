<%@ Page language="c#" Codebehind="Cms.CmsWeb.Maintenance.ContactIndex.aspx.cs" AutoEventWireup="false" Inherits="Cms.CmsWeb.Maintenance.ContactIndex" %>
...
<HTML>
	<HEAD>
		<title>Sample for Wolvorine 3</title>
...
function setbottomMenustyle() {
  
    var call = '<%=Request.QueryString["CALLEDFROM"] %>';
    if (call == "CUSTOMER") {       
	...
	<body  onload="setfirstTime();setbottomMenustyle();top.topframe.main1.mousein = false;if(defaultMode)findMouseIn();" MS_POSITIONING="GridLayout">		
		<!-- To add bottom menu -->
		...
		<div id="bodyHeight" class="pageContent" style='width:100%; overflow: auto;' >
			<table class="<%=tableCssClass%>"  border="0" cellpadding="0" cellspacing="1">
				<tr>
					<td>
