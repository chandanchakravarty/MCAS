...
<%@ Page Language="C#" AutoEventWireup="false" CodeBehind="VesselMasterIndex.aspx.cs" Inherits="Cms.CmsWeb.Maintenance.VesselMasterIndex" %>
							...
							<table class="tableWidthHeader" cellSpacing="0" cellPadding="0" align="center" border="0">
								...
								<tr>
									<td>
										<table class="tableWidthHeader" cellSpacing="0" cellPadding="0" align="center" border="0">
											<tr id="tabCtlRow">
												<td><webcontrol:tab id="TabCtl" runat="server" TabLength="150"  TabTitles="Vessel Master Details" TabURLs="AddVesselMaster.aspx?"></webcontrol:tab></td>
											</tr>
											<tr>
												<td>
