...
{
    public partial class CurrencyMasterIndex : Cms.CmsWeb.cmsbase
    {
       ...
       //protected System.Web.UI.WebControls.Label lblTemplate;
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            string colors = "";
            objResourceMgr = new ResourceManager("Cms.CmsWeb.Maintenance.CurrencyMasterIndex", Assembly.GetExecutingAssembly());
            ...
            try
            {
                ...
                if (strSysID == "ALBAUAT")
                    strSysID = "ALBA";
                string XmlFullFilePath = ClsCommon.WebAppUNCPath + "/cmsweb/support/PageXml/" + strSysID + "/CurrencyMasterDetails.xml";
                ...
                TabCtl.TabURLs = "CurrencyMasterDetails.aspx?&";
                TabCtl.TabLength = 150;
                TabCtl.TabTitles = "Currency Master";
            }
            catch (Exception ex)
            { throw (ex); }
            #endregion
        ...
        //{
        //    frmDetail.Attributes.Add("src", "CurrencyMasterDetails.aspx?M=N");
