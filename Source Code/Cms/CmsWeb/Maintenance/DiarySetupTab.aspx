...
<%@ Page language="c#" Codebehind="DiarySetupTab.aspx.cs" AutoEventWireup="false" Inherits="Cms.CmsWeb.Maintenance.DiarySetupTab" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
  <HEAD>
    <title>DiarySetupTab</title>
					...
					<tr id="formTable" runat="server">
						<td>
							<table class="tableWidthHeader" cellSpacing="0" cellPadding="0" border="0" align="center">
								...
								<tr>
									<td>
										<webcontrol:Tab ID="TabCtl" runat="server" TabURLs="DiarySetup.aspx?,FollowUpSetup.aspx?" TabLength="300"></webcontrol:Tab>
									</td>
								</tr>
								<tr>
									<td>
