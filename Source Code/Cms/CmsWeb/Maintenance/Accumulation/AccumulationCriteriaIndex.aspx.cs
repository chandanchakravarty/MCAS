...
{
    public partial class AccumulationCriteriaIndex : Cms.CmsWeb.cmsbase
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                string XmlFullFilePath = ClsCommon.WebAppUNCPath + "/cmsweb/support/PageXml/" + strSysID + "/AccumulationCriteriaIndex.xml ";
                ...
                TabCtl.TabURLs = "AddAccumulationCriteria.aspx?&";
                TabCtl.TabLength = 150;

                TabCtl.TabTitles = "Accumulation Criteria";
