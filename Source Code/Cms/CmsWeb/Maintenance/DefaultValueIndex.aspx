...
<%@ Page language="c#" Codebehind="DefaultValueIndex.aspx.cs" AutoEventWireup="false" Inherits="Cms.CmsWeb.Maintenance.DefaultValueIndex" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>DefaultMessageIndex</title>
								...
								<tr>
									<td>
										<table class="tableWidthHeader" cellSpacing="0" cellPadding="0" border="0" align="center">
											<tr id="tabCtlRow">
												<td>
													<asp:PlaceHolder ID="plhTabHolder" Runat="server"></asp:PlaceHolder>
												</td>
											</tr>
											<tr>
												<td>
