...
if(name=='top1') width="18%";
else if(name=='top3') width="22%";
else if(name=='top5') width="22%";
else if(name=='top6') width="20%";
else if(name=='top7') width="18%";
if(parent=='top1') width="18%";
else if(parent=='top3') width="18%";
else if(parent=='top5') width="22%";
else if(parent=='top6') width="20%";
else if(parent=='top7') width="17.7%";

	this.m[name]=new Object(); 
	var obj=this.m[name]; obj.name=name;	obj.subs=new Array(); obj.parent=parent; var tt
	...
	// added by Raman Singh
	if(name == 'sub30' || name == 'sub31' || name == 'sub32'){
		this.l[l].style =this.l[l].style + "; text-align:left"
		
		//this.l[l].left =this.l[l]left + "; text-align:left"
		//this.l[l].offsetX=String(prop1["offsetX"])!="undefined"?100:1000
...
function cm_go(name){
	...
	//url="/web/eou/"+ url;   //Chitr// //****change this whenever u change the server*******
		...
		}else if(target=="_blank") window.open(url,'','toolbar=no, directories=no, location=no, status=yes, menubar=no, resizable=yes, scrollbars=no,  width=900, height=500')
...
function makeCoolMenu(name){
	...
	bw.filter=(bw.ie6||bw.ver.indexOf("MSIE 7")>-1||bw.ver.indexOf("MSIE 5.5")>-1) && !bw.mac
}
/************
Find frame
*************/
