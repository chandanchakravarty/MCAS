<%@ Page language="c#" Codebehind="SubmitQuestion.aspx.cs" AutoEventWireup="false" Inherits="Cms.CmsWeb.UserDefined.SubmitQuestion" %>
	...
	<HEAD>
		...
		<meta name="vs_targetSchema" content="http://schemas.microsoft.com/intellisense/ie5">
			...
			function fnMovePrev()
			{
				...
				{					
					self.location.href="SubmitGroups.aspx?CalledFrom="+lStrCalledFrom+"&TabID="+lStrTab+"&ScreenID="+lStrBack;
				}
				else
				{
			...
			function fnPreviewQuestion()
			{
				...
				var arrGrp=locQueryStr.split("&");
				if(arrGrp.length>1)
				{
					var arrgrp1=arrGrp[1].split("=");
				
					if(arrgrp1.length>0)
						lStrGroupID=arrgrp1[1];			
				...
				{
					window.open("PreviewQuestion.aspx?CalledFrom="+lStrCalledFrom+"&QID="+value+"&ScreenID="+lStrBack+"&TabID="+lStrTab+"&groupID="+lStrGroupID,'','width=500,height=250,menubars=NO,scrollbars=yes,top=225,left=250,statusbar=NO,toolbars=NO');
				}			
			}
		</script>
	</HEAD>
				...
				<table class="tableWidth" border="0" cellpadding="0" cellspacing="0">
					<tr>
						<td>
								...
								<tr>
									<td>
										<table class="tableWidthHeader" cellSpacing="0" cellPadding="0" border="0" align="center">
											<tr id="tabCtlRow">
												<td>
													<webcontrol:Tab ID="TabCtl" runat="server" TabURLs="GridQuestion.aspx?" TabTitles="Question Details"
							...
							<input type="hidden" name="hidTabID" id="hidTabID" runat=server  > 
							<input type="hidden" name="hidGroupID" id="hidGroupID" runat=server  > 
							<input type="hidden" name="hidCalledFrom" id="hidCalledFrom" runat=server  > 
						</td>
					</tr>
				</table>
			</form>
