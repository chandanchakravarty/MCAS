...
<%@ Page language="c#" Codebehind="SubmitGroups.aspx.cs" AutoEventWireup="false" Inherits="Cms.CmsWeb.User_Defined.SubmitGroups" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>SubmitGroups</title>
		...
		{	
			...
			lStrBack=document.SubmitGroups.hidTemplateID.value;
			var lstrTabID = document.SubmitGroups.hidTabId.value ;
		
			var lStrGrdMsg="Please select group from list.";	// Storing the alert message in the variable.		
			var CalledFrom = "P";
			...
			{
				window.location = "SubmitQuestion.aspx?CalledFrom="+CalledFrom+"&GroupID="+value+"&ScreenID="+lStrBack+"&TabID="+lstrTabID;
			}
		}
		function fnChangeQuestionOrder()
		{	
			var lStrBack;
			lStrBack=document.SubmitGroups.hidTemplateID.value;
			var lstrTabID = document.SubmitGroups.hidTabId.value ;
			...
			{
				window.location = "QuestionSequenceChange.aspx?CalledFrom="+CalledFrom+"&GroupID="+value+"&ScreenID="+lStrBack+"&TabID="+lstrTabID;
			}
		}
		function fnMovePrev()
		{
			var CalledFrom = "P";
			self.location.href="SubmitTab.aspx?CalledFrom="+CalledFrom+"&ScreenID="+document.SubmitGroups.hidTemplateID.value;
		}
		function fnSubmitRules()
		{
			var lStrScreenID;
			var lStrGrdMsg="Please select group from list.";
			var lStrBack;
			lStrBack=document.SubmitGroups.hidTemplateID.value;
			var lstrTabID = document.SubmitGroups.hidTabId.value ;
			var CalledFrom = "P";
			...
			{
				window.location = "QuoteRules.aspx?QID=&TABID=" + lstrTabID + "&SCREENID=" + lStrBack + "&GROUPID="+value;
			}
	...
	<body leftmargin="0" topmargin="0" onload="setfirstTime();top.topframe.main1.mousein = false;findMouseIn();"
		...
		<div id="bodyHeight" class="pageContent">
			<form id="SubmitGroups" method="post" runat="server">
				<table class="tableWidth" border="0" cellpadding="0" cellspacing="0">
					<tr>
						<td>
								...
								<tr>
									<td>
										<table class="tableWidthHeader" cellSpacing="0" cellPadding="0" border="0" align="center">
											<tr id="tabCtlRow">
												<td>
													<webcontrol:Tab ID="TabCtl" runat="server" TabURLs="GroupDetails.aspx?" TabTitles="Group Details"
							...
							<input type="hidden" name="hidTabId" id="hidTabId" runat="server"> <input type="hidden" name="hidlocQueryStr" id="hidlocQueryStr">
							<input type="hidden" name="hidMode"> <input id="hide" type="hidden" name="ConVar">
