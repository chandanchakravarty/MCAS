<%@ Page language="c#" Codebehind="SubmitScreen.aspx.cs" AutoEventWireup="false" Inherits="Cms.CmsWeb.User_Defined.SubmitScreen" %>
...
<HTML>
	<HEAD>
		...
		function fnMappingScreen(){
			var szTemplateID = locQueryStr;
			var lStrGrdMgs="Please select screen first";	
			...
			{
				window.open("QuestionMapping.aspx?ScreenID=" + value,'','width=500,height=250,menubars=NO,scrollbars=yes,top=225,left=250,statusbar=NO,toolbars=NO');				
			}		
		...
		{
			//var szTemplateID = document.SubmitScreen.hidTemplateID.value;
			...
			{
				window.location = "SubmitTab.aspx?ScreenID="+value+"&CalledFrom=P" ; //Calling the Tab Page with the selected ScreenID.
			}		
		}
		function fnSubmitTabOrder()
		{
			var szTemplateID = locQueryStr;
			var arrszTemplateID;
			var value;
			...
			{
				window.location = "ChangeTabOrder.aspx?CalledFrom=P&ScreenID="+value ; //Calling the Tab Page with the selected ScreenID.
			}		
		}
		
		function fnPreviewScreen()
		{
			var szTemplateID = locQueryStr;
			...
			{
			window.open("PreviewUserQuestionTab.aspx?CalledFrom=P&ScreenID="+value,'','width=800,height=725,scrollbars=yes,menubars=NO,top=0,left=100,statusbar=NO,toolbars=NO');
				
			//	window.location = "PreviewUserQuestionTab.aspx?ScreenID="+szTemplateID; //Calling the Preview Page with the selected ScreenID.
			}		
		}
		
		function fnCopyScreen()
		{
			var szTemplateID = locQueryStr;
			var arrszTemplateID;
			var value;
			...
			{				
				window.open("CopyScreen.aspx?CalledFrom=P&ScreenID="+value,'','width=600,height=225,scrollbars=yes,menubars=NO,top=225,left=250,statusbar=NO,toolbars=NO');			
			}		
		}
		
		</script>
	</HEAD>
	<body  oncontextmenu = "return false;" leftmargin="0" topmargin="0" onload="setfirstTime();top.topframe.main1.mousein = false;findMouseIn();" MS_POSITIONING="GridLayout">
		<DIV id="myTSMain" style="BEHAVIOR: url(/cms/cmsweb/htc/webservice.htc)"></DIV>
		<!-- To add bottom menu -->
		<webcontrol:Menu id="bottomMenu" runat="server"></webcontrol:Menu>
		<!-- To add bottom menu ends here -->
		<div id="bodyHeight" class="pageContent">
			<form id="SubmitScreen" method="post" runat="server">
