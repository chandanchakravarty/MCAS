<%@ Page language="c#" Codebehind="RegCommSetup_AgencyIndex.aspx.cs" AutoEventWireup="false" Inherits="Cms.CmsWeb.Accounting.RegCommSetup_AgencyIndex" %>
...
<HTML>
	<HEAD>
		<title>BRICS-Regular Commission Setup - Agency.</title>
								...
								<tr>
									<td>
										<table class="tableWidthHeader" cellSpacing="0" cellPadding="0" border="0" align="center">
											<tr id="tabCtlRow">
												<td>
													<webcontrol:Tab ID="TabCtl" runat="server" TabURLs="AddRegCommSetup_Agency.aspx?" TabTitles="Agency Commission"
