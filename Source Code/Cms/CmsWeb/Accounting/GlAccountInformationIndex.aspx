<%@ Page language="c#" Codebehind="GlAccountInformationIndex.aspx.cs" AutoEventWireup="false" Inherits="Cms.CmsWeb.Maintenance.Accounting.GlAccountInformationIndex" %>
...
<HTML>
	...
	<body oncontextmenu = "return false;" onload="setfirstTime();top.topframe.main1.mousein = false;" MS_POSITIONING="GridLayout">
								...
								<tr>
									<td>
										<table class="tableWidthHeader" cellSpacing="0" cellPadding="0" border="0" align="center">
											<tr id="tabCtlRow">
												<td>
													<webcontrol:Tab ID="TabCtl" runat="server" TabURLs="AddGlAccountInformation.aspx?" TabTitles="GL Accounts" TabLength="150"></webcontrol:Tab>
												</td>
											</tr>
											<tr>
												<td>
