<%@ Page language="c#" Codebehind="TransactionCodeGroupIndex.aspx.cs" AutoEventWireup="false" Inherits="Cms.CmsWeb.Accounting.TransactionCodeGroupIndex" %>
...
<HTML>
	<HEAD>
		<title>BRICS-Transaction Code Group.</title>
								...
								<tr>
									<td>
										<table class="tableWidthHeader" cellSpacing="0" cellPadding="0" border="0" align="center">
											<tr id="tabCtlRow">
												<td>
													<webcontrol:Tab ID="TabCtl" runat="server" TabURLs="AddTransactionCodeGroup.aspx?" TabTitles="Transaction Code Group"
														TabLength="230"></webcontrol:Tab>
												</td>
											</tr>
											<tr>
												<td>
