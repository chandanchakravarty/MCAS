...
<%@ Page language="c#" Codebehind="ChartOfAccountRangesTabIndex.aspx.cs" AutoEventWireup="false" Inherits="Cms.CmsWeb.Maintenance.Accounting.ChartOfAccountRangesTabIndex" %>
					...
					<tr id="formTable" runat="server">
						<td>
							<table class="tableWidthHeader" cellSpacing="0" cellPadding="0" border="0" align="center">
								...
								<tr>
									<td>
										<webcontrol:Tab ID="TabCtl" runat="server" TabURLs="ChartOfAccountsRange.aspx?,SubRangesIndex.aspx?" TabTitles="Chart Of Accounts Ranges,Sub Ranges"
											TabLength="300"></webcontrol:Tab>
									</td>
								</tr>
								<tr>
									<td>
