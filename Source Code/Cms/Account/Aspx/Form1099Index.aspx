...
<%@ Page language="c#" AutoEventWireup="false" CodeBehind="Form1099Index.aspx.cs" Inherits="Cms.Account.Aspx.Form1099Index" %>
...
<HTML>
	<HEAD>
		...
		<script language="javascript">
			...
			function SetYear1099()
			{
				document.getElementById("hidYear1099").value = document.getElementById("cmbYEAR_1099") .options[document.getElementById("cmbYEAR_1099").selectedIndex].value;
			}
				...
				<tr>
					<td>
						<table class="tableWidthHeader" cellSpacing="0" cellPadding="0" border="0" align="center">
							...
							<tr height="10px">
								<td class="midcolora">
									Select 1099 Processing Year :  &nbsp;&nbsp;<asp:dropdownlist id="cmbYEAR_1099" runat="server" AutoPostBack="true" onchange="SetYear1099();"></asp:dropdownlist>
								<br>
								</td>
							</tr>	
							<tr>
							...
							<tr>
								<td>					
									<table class="tableWidthHeader" cellSpacing="0" cellPadding="0" border="0" align="center">
										<tr id="tabCtlRow">
											<td>
												<webcontrol:Tab ID="TabCtl" runat="server" TabURLs="AddPriorPolicy.aspx?" TabTitles="Form 1099" TabLength="150"></webcontrol:Tab>
											</td>
										</tr>
										<tr>
											<td>
						...
						<INPUT id="hidYear1099" type="hidden" name="hidYear1099" runat="server">			
					</td>
				</tr>
			</table>
			</form>
