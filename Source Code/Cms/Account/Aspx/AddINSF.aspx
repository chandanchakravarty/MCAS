...
<%@ Page language="c#" Codebehind="AddINSF.aspx.cs" AutoEventWireup="false" Inherits="Cms.Account.Aspx.AddINSF" %>
...
<HTML>
	<HEAD>
		<title>ChargeInstallmentFees</title>
	...
	<script language = javascript>
		...
		function FetchXML(PolNum,RowNo)
		{
			...
			var Action = 'INSTALLMENT_FEES';			
			strRowNum = RowNo;			
			_SendAJAXRequest(objRequest,'INSTALLMENT_FEES',ParamArray,CallBackFun);
		}		
				...
				<tr>
					<td>
						<TABLE id="Table1" cellSpacing="1" cellPadding="0" width="100%" align="center" border="0">
							<tr>
								<td class="headereffectcenter">Charge Installment Fees For Policies
								</td>
							</tr>
							<tr>
								...
								<td class="midcolora" width="40%">
									<asp:datagrid id="dgDepositDetails" runat="server" DataKeyField="First" AutoGenerateColumns="False"
										...
										<Columns>
											...
											<asp:TemplateColumn HeaderText="Installment Fee" ItemStyle-Width="12%">
												<ItemTemplate>
													...
													<asp:CustomValidator ID="csvTOTAL_DUE" Runat="server" ControlToValidate="txtTOTAL_DUE" Display="Dynamic"
														ErrorMessage="Please enter Installment Fee  amount" ClientValidationFunction="ValidateRECEIPT_AMOUNT"></asp:CustomValidator>
												</ItemTemplate>
											</asp:TemplateColumn>
