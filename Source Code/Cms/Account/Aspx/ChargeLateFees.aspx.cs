...
namespace Cms.Account.Aspx
{
	...
	/// </summary>
	public class ChargeLateFees : Cms.Account.AccountBase  
	{
		...
		private void Page_Load(object sender, System.EventArgs e)
		{
			...
			//base.ScreenId = "438";
			base.ScreenId = "437";		//Commented and added on 18/9/2009 for #6135.
...
//					}
			...
			if(alRecr.Count!=0)
			{
				returnResult=objNSFEntry.InsertLateFee(alRecr);
				if ( returnResult >0)
				{
