<%@ Page language="c#" Codebehind="DepositSelect.aspx.cs" AutoEventWireup="false" Inherits="Cms.Account.Aspx.DepositSelect" %>
				...
				<tr>
					<td>
						<table class="tableWidthHeader" cellSpacing="0" cellPadding="0" border="0" align="center">
							<form id="indexForm1" method="post" runat="server">
								...
								<tr>
									<td>
										<table class="tableWidthHeader" cellSpacing="0" cellPadding="0" border="0" align="center">
											<tr id="tabCtlRow">
												<td>
													<webcontrol:Tab ID="TabCtl" runat="server" TabURLs="DepositIndex.aspx?DEPOSIT_ID=" TabTitles="Deposit"
						...
						<!--//added on 27/04/2005-->
						<input type="hidden" name="hidSELECTED_DEP_ID" id="hidSELECTED_DEP_ID" value="0">
						</FORM>
					</td>
				</tr>
			</table>
