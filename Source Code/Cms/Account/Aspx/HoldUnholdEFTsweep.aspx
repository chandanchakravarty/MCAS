...
<%@ Page language="c#" Codebehind="HoldUnholdEFTsweep.aspx.cs" AutoEventWireup="false" Inherits="Cms.Account.Aspx.EFTsweep" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>Hold Unhold EFT Sweep</title>
		...
		function Hold()
		{
			...
			{
				alert("Please select atleast one EFT sweep to Hold");
				return false;
			}
			else
			{
		...
		function Unhold()
		{
			...
			if(SelectedIDs == "" || SelectedIDs == ",")
			{
				alert("Please select atleast one EFT sweep to Unhold");
				return false;
			}
			else
			{
