<%@ Page language="c#" Codebehind="BudgetPlanIndex.aspx.cs" AutoEventWireup="false" Inherits="Cms.Account.Aspx.BudgetPlanIndex" %>
								...
								<tr>
									<td>
										<TABLE class="tableWidthHeader" cellSpacing="0" cellPadding="0" border="0" align="center">
											<tr id="tabCtlRow">
												<td>
													<webcontrol:Tab ID="TabCtl" runat="server" TabURLs="AddPlanBudget.aspx?" TabTitles="Plan Budget" TabLength="150"></webcontrol:Tab>
												</td>
											</tr>
											<tr>
												<td>
