...
<%@ Page language="c#" Codebehind="AddResintatementFees.aspx.cs" AutoEventWireup="false" Inherits="Cms.Account.Aspx.AddResintatementFees" validateRequest="false" %>
...
<HTML>
	<HEAD>
		<title>AddReinstatementFees</title>
		...
		{	
			...
			//alert('dgDepositDetails__ctl'+ strRowNum + 'control' ); 
			 if(lblStatus !=null)
			{
			    if(PolicyStatus[1]== 5)
			    {
		...
		function FetchXML(PolNum,RowNo)
		{
			...
			var Action = 'RESIN_FEES';			
			strRowNum = RowNo;			
			_SendAJAXRequest(objRequest,'RESIN_FEES',ParamArray,CallBackFun);
		}		
	...
	<body oncontextmenu = "return false;" leftMargin="0" topMargin="0" onload="setfirstTime();top.topframe.main1.mousein = false;showScroll();findMouseIn();"
				...
				<tr>
					<td>
						<TABLE id="Table1" cellSpacing="1" cellPadding="0" width="100%" align="center" border="0">
							<tr>
								<td class="headereffectcenter">Charge Reinstatement Fees For Policies
								</td>
							</tr>
							<tr>
										...
										<Columns>
											...
											<asp:TemplateColumn HeaderText="Policy #" ItemStyle-Width="11%">
												<ItemTemplate>
													...
													<input type="hidden" id="hidPOLICY_ID" runat="server" NAME="hidPOLICY_ID"> <input type="hidden" id="hidPOLICY_VERSION_ID" runat="server" NAME="hidPOLICY_VERSION_ID">
											...
											<asp:TemplateColumn HeaderText="Reinstatement Fee" ItemStyle-Width="12%">
												<ItemTemplate>
													...
													<asp:CustomValidator ID="csvTOTAL_DUE" Runat="server" ControlToValidate="txtTOTAL_DUE" Display="Dynamic"
														ErrorMessage="Please enter Reinstatement amount" ClientValidationFunction="ValidateRECEIPT_AMOUNT"></asp:CustomValidator>
												</ItemTemplate>
											</asp:TemplateColumn>
