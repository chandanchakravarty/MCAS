<%@ Page language="c#" Codebehind="CreditCardSweepHistory.aspx.cs" AutoEventWireup="false" Inherits="Cms.Account.Aspx.CreditCardSweepHistory" %>
...
<HTML>
	<HEAD>
		<title>CreditCardSweepHistory</title>
				...
				<table class="tableWidth" cellSpacing="1" cellPadding="0" align="center" border="0">
					...
					<tr>
						<td class="pageheader" align="center" colSpan="4">Please select Run Report Button 
							to view Credit Card Sweep History Detail</td>
					</tr>
					<tr>
						<td class="headereffectcenter" colSpan="4">Credit Card Sweep History</td>
					</tr>
					<tr>
					...
					<tr>
					<td class="midcolora" width="18%">Status</td>
					<TD class="midcolora" colSpan="1"><asp:dropdownlist id="paypalStatusList" runat="server">
					...
					<tr>
						<td class="midcolora" width="18%">Users</td>
						<td class="midcolora" colSpan="1"><asp:ListBox id='txtUsers' runat='server' Height="100px" Width="200px" SelectionMode="Multiple"></asp:ListBox></td>						
