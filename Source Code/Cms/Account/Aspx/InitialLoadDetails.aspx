<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InitialLoadDetails.aspx.cs" Inherits="Cms.Account.Aspx.InitialLoadDetails" %>
...
<head id="Head1" runat="server">
    <title>Initial Details</title>
     ...
     <script language='javascript' type="text/javascript">
         ...
         {
             var strStatus = document.getElementById('hidStatus').value;
             if (strStatus == "WTCHS") 
             {
                 var flag = document.getElementById('hidtrue').value;
                 if (flag == "false") 
                 {
...
<body>
    ...
    <input type="hidden" name="hidtrue" id="hidtrue" runat="server" />
    <input type="hidden" name="hidStatus" id="hidStatus" runat="server" />
   </form>
</body>
</html>
