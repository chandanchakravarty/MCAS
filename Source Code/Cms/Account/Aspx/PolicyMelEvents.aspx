<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PolicyMelEvents.aspx.cs" Inherits="Cms.Account.Aspx.PolicyMelEvents" %>
			...
			<table class="tableWidth" border="0" cellpadding="0" cellspacing="0">
				<tr>
					<td>
						...
						<input type="hidden" name="hidROW_ID">						
						<input type="hidden" name="hidMode">
						</FORM>
					</td>
				</tr>
