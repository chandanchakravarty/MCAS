<%@ Page language="c#" Codebehind="AcceptedCOILoadIndex.aspx.cs" AutoEventWireup="false" Inherits="Cms.Account.Aspx.AcceptedCOILoadIndex" %>
								...
								<tr>
									<td>
										<TABLE class="tableWidthHeader" cellSpacing="0" cellPadding="0" border="0" align="center">
											<tr id="tabCtlRow">
												<td>
													<webcontrol:Tab ID="TabCtl" runat="server" TabURLs="AddVendorInvoice.aspx?" TabTitles="Vendor Invoice" TabLength="150"></webcontrol:Tab>
												</td>
											</tr>
											<tr>
												<td>
