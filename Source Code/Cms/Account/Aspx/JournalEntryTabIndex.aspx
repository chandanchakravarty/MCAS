<%@ Page language="c#" Codebehind="JournalEntryTabIndex.aspx.cs" AutoEventWireup="false" Inherits="Cms.Account.Aspx.JournalEntryTabIndex" %>
			...
			<table class="tableWidth" border="0" cellpadding="0" cellspacing="0">
				<tr>
					<td>
								...
								<tr>
									<td>
										<table class="tableWidthHeader" cellSpacing="0" cellPadding="0" border="0" align="center">
											<tr id="tabCtlRow">
												<td>
													<webcontrol:Tab ID="TabCtl" runat="server" TabURLs="JournalEntryMasterIndex.aspx?" TabTitles="Manual Journal Entry"
						...
						<input type="hidden" name="hidSELECTED_JOURNAL_ID" id="hidSELECTED_JOURNAL_ID" value="0">
