<%@ Page language="c#" Codebehind="LiabilityTypeIndex.aspx.cs" AutoEventWireup="false" Inherits="Cms.Claims.Aspx.LiabilityTypeIndex" %>
...
<HTML>
  <HEAD>
		<title>LiabilityTypeIndex</title>
			...
			<table  border="0" cellpadding="0" cellspacing="0" width="99%">
				<tr>
					<td>
						...
						<input type="hidden" name="hidCLAIM_ID" id="hidCLAIM_ID" runat="server"> </FORM>
					</td>
				</tr>
			</table>
		</div>
