...
namespace Cms.Claims.Aspx
{
	...
	/// </summary>
	public class AgencyDetailIndex : Cms.Claims.ClaimBase
	{
		...
		private void Page_Load(object sender, System.EventArgs e)
		{
			...
			try
			{
				...
				((BaseDataGrid)c1).SelectClause ="CLAIM_ID,AGENCY_ID,AGENCY_CODE,AGENCY_SUB_CODE,AGENCY_CUSTOMER_ID,AGENCY_PHONE,AGENCY_FAX,IS_ACTIVE";
				//specifying tables for from clause
				((BaseDataGrid)c1).FromClause=" CLM_AGENCY CA";
				...
				((BaseDataGrid)c1).SearchColumnHeadings="Agency Code^Sub-Code^Agency Customer ID^Phone^Fax";
				//specifying column to be used for combo box
				((BaseDataGrid)c1).SearchColumnNames="AGENCY_CODE^AGENCY_SUB_CODE^AGENCY_CUSTOMER_ID^AGENCY_PHONE^AGENCY_FAX";
				...
				((BaseDataGrid)c1).OrderByClause="AGENCY_ID asc";
				...
				((BaseDataGrid)c1).DisplayColumnNames="AGENCY_CODE^AGENCY_SUB_CODE^AGENCY_CUSTOMER_ID^AGENCY_PHONE^AGENCY_FAX";
				//specifying text to be shown as column headings				
				((BaseDataGrid)c1).DisplayColumnHeadings="Agency Code^Sub-Code^Agency Customer ID^Phone^Fax";
				...
				//specifying heading
				((BaseDataGrid)c1).HeaderString = "Agency";
				...
				TabCtl.TabURLs   =  "AddAgencyDetail.aspx?&CLAIM_ID=" + hidCLAIM_ID.Value + "&";
				TabCtl.TabTitles = "Agency";
			}
			catch(Exception ex)
			{
