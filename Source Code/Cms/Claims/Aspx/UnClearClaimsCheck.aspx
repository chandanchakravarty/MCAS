<%@ Page language="c#" Codebehind="UnClearClaimsCheck.aspx.cs" AutoEventWireup="false" Inherits="Claims.Aspx.UnClearClaimsCheck" %>
...
<HTML>
	<HEAD>
		...
		function UnclearClaimCheck()
		{
			...
			{
				alert("Please select atleast one check for un-clearing");
				return false;
			}
			else
			{
					VoidChecks();					 
					__doPostBack('UnClearChecks','0')
			}	
		}
