<%@ Page language="c#" Codebehind="ReserveBreakDownIndex.aspx.cs" AutoEventWireup="false" Inherits="Cms.Claims.Aspx.ReserveBreakDownIndex" %>
...
<HTML>
	<HEAD>
		<title>ReserveBreakDownIndex</title>
			...
			<table width="95%" border="0" cellpadding="0" cellspacing="0">
				...
				<tr>
					<td>
									...
									<td>
										<table class="tableWidthHeader" cellSpacing="0" cellPadding="0" border="0" align="center">
											<tr id="tabCtlRow" runat="server">
												<td>
													<webcontrol:Tab ID="TabCtl" runat="server" TabTitles="Claims Reserve Breakdown"
						...
						<input type="hidden" name="hidCLAIM_ID" runat="server" id="hidCLAIM_ID"> 
						<input type="hidden" name="hidACTIVITY_ID" runat="server" id="hidACTIVITY_ID">
