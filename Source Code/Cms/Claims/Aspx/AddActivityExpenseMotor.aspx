<%@ Page language="c#" Codebehind="AddActivityExpenseMotor.aspx.cs" AutoEventWireup="false" Inherits="Cms.Claims.Aspx.AddActivityExpenseMotor" %>
								...
								<tr class="midcolora" id="trTotalPayments" runat="server">
									...
									<td class="midcolora" colSpan="3">
										<table width="100%" border="0" >
											<tr>
												<td width="31%" class="midcolora"></td>
												<TD width="51%"><asp:textbox class="midcolora" id="txtTOTAL_OUTSTANDING" Runat="server" ReadOnly="True" BorderWidth="0"  size="15"
