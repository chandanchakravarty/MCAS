<%@ Page language="c#" Codebehind="AddActivityUmbRecovery.aspx.cs" AutoEventWireup="false" Inherits="Cms.Claims.Aspx.AddActivityUmbRecovery" %>
...
<HTML>
  <HEAD>
		...
		<script language="javascript">
			...
			var policyRows=0;						
			var ctl = "ctl";
			var RecoveryGridID='<%=RecoveryDataGridID%>';									
			var PolicyPrefix=RecoveryGridID + "__" + ctl;
		...
		<div id="bodyHeight" class="pageContent">
			<form id="Form1" method="post" runat="server">
				<TABLE cellSpacing=0 cellPadding=0 width="100%">
					<tr>
						<td class="headereffectCenter" colspan="4"><asp:label id="lblTitle" runat="server">Recovery Payment</asp:label></td>
					</tr>
					<tr>
					...
					<TR id="trBody" runat="server">
						<TD colspan="4">
							<table cellSpacing="0" cellPadding="0" WIDTH="100%">
								<tr id="trRecovery" runat="server">
									<TD class="headerEffectSystemParams" colSpan="4">Recovery Payment</TD>
								</tr>
								<tr id="trVehicleGridRow" runat="server">
									<td class="midcolora" colSpan="4">
										<asp:datagrid id="dgRecovery" runat="server" AutoGenerateColumns="False" Width="100%">
											...
											<Columns>												
												...
												<asp:TemplateColumn HeaderText="Recovery Amount" ItemStyle-Width="12%" ItemStyle-CssClass="midcolorr">
													<ItemTemplate>
														<asp:TextBox ID="txtAMOUNT" CssClass="INPUTCURRENCY" Runat="server" MaxLength="14"  ></asp:TextBox><br>
														<%--<asp:RangeValidator ID="rngAMOUNT" MinimumValue="1" MaximumValue="9999999999" Type="Currency" Runat="server"
									...
									<td class="midcolora" colSpan="3">
										<table width="100%" border="0">
											<tr>
												...
												<TD width="45%">&nbsp;<asp:textbox class="midcolora" id="txtTOTAL_OUTSTANDING" Runat="server" ReadOnly="True" BorderWidth="0" size="15" BorderStyle="None"></asp:textbox>
												&nbsp;<asp:textbox  id="txtTotalRI_Reserve" class="midcolora" Runat="server" ReadOnly="True" BorderWidth="0" size="15"
