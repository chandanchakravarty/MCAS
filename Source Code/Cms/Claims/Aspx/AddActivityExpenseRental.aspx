...
<%@ Page language="c#" Codebehind="AddActivityExpenseRental.aspx.cs" AutoEventWireup="false" Inherits="Cms.Claims.Aspx.AddActivityExpenseRental" %>
...
<HTML>
	<HEAD>
		...
		<script language="javascript">
			...
			var Section2Rows=0;			
			var ctl = "ctl";
			var Section2PaymentGridID='<%=PaymentDataGridID%>';			
			var Section1PaymentGridID='<%=Section1PaymentDataGridID%>';			
			var Section1Prefix=Section1PaymentGridID + "__" + ctl;
			var Section2Prefix=Section2PaymentGridID + "__" + ctl;
			...
			{		
				var Sum = parseFloat(0);				
				Sum = CalculateTotal(Section1Prefix,PaymentPrefix) + CalculateTotal(Section2Prefix,PaymentPrefix);																				
...
<tr>
	<TD id="tdClaimTop" class="pageHeader" colSpan="4">
		<webcontrol:ClaimTop id="cltClaimTop" runat="server" width="100%"></webcontrol:ClaimTop>
					...
					<TR id="trBody" runat="server">
						<TD colspan="4">
							<table cellSpacing="0" cellPadding="0" WIDTH="100%">
								...
								<tr id="trSection1Payment" runat="server">
									<TD class="headerEffectSystemParams" colSpan="4">Section I Payments</TD>
								</tr>
								<tr>
									<td class="midcolora" colspan="4">
										<asp:datagrid id="dgSection1Payment" runat="server" AutoGenerateColumns="False" Width="100%">
											...
											<Columns>
												...
												<asp:TemplateColumn HeaderText="Payment Amount" ItemStyle-Width="10%">
													<ItemTemplate>
														<asp:TextBox ID="txtPAYMENT_AMOUNT" Runat="server" CssClass="INPUTCURRENCY" MaxLength="14"  >></asp:TextBox><br>
								...
								<tr id="trSection2Payment" runat="server">
									<TD class="headerEffectSystemParams" colSpan="4">Section II Payments</TD>
								</tr>
								<tr>
									<td class="midcolora" colspan="4">
										<asp:datagrid id="dgSection2Payment" runat="server" AutoGenerateColumns="False" Width="100%">
											<AlternatingItemStyle CssClass="midcolora"></AlternatingItemStyle>
											<ItemStyle CssClass="midcolora"></ItemStyle>
											<HeaderStyle CssClass="headereffectWebGrid"></HeaderStyle>
											<Columns>
								...
								<tr>
									<td colspan="4" class="midcolorr">
										<asp:label id="capADDITIONAL_EXPENSE" runat="server">Amount</asp:label>&nbsp;&nbsp;&nbsp;
										<asp:textbox id="txtADDITIONAL_EXPENSE" runat="server" CssClass="INPUTCURRENCY" size="19" maxlength="14"></asp:textbox><br>
								...
								<tr class="midcolora" id="trTotalPayments" runat="server">
									...
									<td class="midcolora" colSpan="3">
										<table width="100%" border="0">
											<tr>
												<td width="47%" class="midcolora"></td>
												<TD width="37%"><asp:textbox class="midcolora" id="txtTOTAL_OUTSTANDING" Runat="server" ReadOnly="True" BorderWidth="0" 
														size="15" BorderStyle="None"></asp:textbox></TD>
												<TD><asp:textbox id="txtTOTAL_PAYMENT" class="midcolora" Runat="server" ReadOnly="True" BorderWidth="0" 
														size="15" BorderStyle="None"></asp:textbox></TD>
											</tr>
										</table>
									</td>
				...
				<INPUT id="hidCustomerID" type="hidden" name="hidCustomerID" runat="server"> <INPUT id="hidSection1RowCount" type="hidden" name="hidSection1RowCount" runat="server"
					value="0"> <INPUT id="hidSection2RowCount" type="hidden" name="hidSection2RowCount" runat="server"
					value="0"> <INPUT id="hidCLAIM_ID" type="hidden" name="hidCLAIM_ID" runat="server">
				<INPUT id="hidACTIVITY_ID" type="hidden" name="hidACTIVITY_ID" runat="server"> <INPUT id="hidPayeeID" type="hidden" name="hidPayeeID" runat="server">
			</form>
		</div>
	</body>
</HTML>
