...
namespace Cms.Claims.Aspx
{
	...
	/// </summary>
	public class AddActivityExpense : Cms.Claims.ClaimBase//System.Web.UI.Page //
	{
...
//		public DataTable gDtOldData=null;
		...
		private void Page_Load(object sender, System.EventArgs e)
		{
			...
			objResourceMgr = new System.Resources.ResourceManager("Cms.Claims.Aspx.AddActivityExpense"  ,System.Reflection.Assembly.GetExecutingAssembly());
...
//		}
		...
		private void SetErrorMessages()
		{
			...
			//revADDITIONAL_EXPENSE.ValidationExpression	= aRegExpCurrencyformat;//Done by Sibin on 10 Feb 09 for Itrack Issue 5385-TO MOVE TO LOCAL VSS
...
//				((RangeValidator)(e.Item.FindControl("rngPAYMENT_AMOUNT"))).ErrorMessage	  = Cms.CmsWeb.ClsMessages.FetchGeneralMessage("216");				
				...
				//lblRI_Reserve.Text = Convert.ToString(DataBinder.Eval(e.Item.DataItem,"RI_RESERVE"));
		...
		private void btnSave_Click(object sender, System.EventArgs e)
		{
			try
			{
				...
				{			
					...
					//RegisterStartupScript("ReLoadTab","<script>GoBack('AddActivityExpenseTab.aspx');</script>");			
					GetOldData();
...
//		private void cmbDrAccts_SelectedIndexChanged(object sender, System.EventArgs e)
//		{
//		
//		}		
	}
