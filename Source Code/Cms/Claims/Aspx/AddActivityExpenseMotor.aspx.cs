...
namespace Cms.Claims.Aspx
{
	...
	/// </summary>
	public class AddActivityExpenseMotor : Cms.Claims.ClaimBase
	{
...
//		public DataTable gDtOldData=null;
		...
		private void Page_Load(object sender, System.EventArgs e)
		{
			...
			objResourceMgr = new System.Resources.ResourceManager("Cms.Claims.Aspx.AddActivityExpenseMotor"  ,System.Reflection.Assembly.GetExecutingAssembly());
...
//			capACTION_ON_PAYMENT.Text 	=		objResourceMgr.GetString("cmbACTION_ON_PAYMENT");
		...
		private void BindGrid(DataSet dsData)
		{
			...
			if(dsData!=null && dsData.Tables.Count>VEHICLE_PAYMENT_TABLE && hidCustomerID.Value!="" && hidCustomerID.Value!="0" && hidPolicyID.Value!="" && hidPolicyID.Value!="0" && hidPolicyVersionID.Value!="" && hidPolicyVersionID.Value!="0" && dsData.Tables[VEHICLE_PAYMENT_TABLE].Rows.Count>0)
			{
		...
		private void OnItemDataBound(object sender, System.Web.UI.WebControls.DataGridItemEventArgs e,string dataGridID)
		{
			...
			if(e.Item.ItemType == ListItemType.AlternatingItem || e.Item.ItemType == ListItemType.Item)
			{
				...
				else
				{
					...
					if(lblCOV_ID!=null && lblCOV_ID.Text.Trim().Equals(PIP_COV_ID))
					{
