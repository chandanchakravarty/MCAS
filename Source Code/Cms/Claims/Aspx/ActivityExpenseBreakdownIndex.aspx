<%@ Page language="c#" Codebehind="ActivityExpenseBreakdownIndex.aspx.cs" AutoEventWireup="false" Inherits="Cms.Claims.Aspx.ActivityExpenseBreakdownIndex" %>
...
<HTML>
	...
	<body onload="setfirstTime();" MS_POSITIONING="GridLayout">
									...
									<td>
										<table class="tableWidthHeader" cellSpacing="0" cellPadding="0" border="0" align="center">
											<tr id="tabCtlRow" runat="server">
												<td>
													<webcontrol:Tab ID="TabCtl" runat="server" TabURLs="AddExpertServiceProviders.aspx?" TabTitles="Expert Service Providers"
