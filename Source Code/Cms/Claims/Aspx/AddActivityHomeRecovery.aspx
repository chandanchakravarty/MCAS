<%@ Page language="c#" Codebehind="AddActivityHomeRecovery.aspx.cs" AutoEventWireup="false" Inherits="Cms.Claims.Aspx.AddActivityHomeRecovery" %>
...
<HTML>
	<HEAD>
		...
		<script language="javascript">
			...
			var AmountElementPrefix = "_txtAMOUNT";
			var ScheduledAmountElementPrefix = "txtAMOUNT_";	
			...
			var WaterEquipPaymentPrefix = "txtWATER_EQUIP_RECOVERY_AMOUNT_";
			var WaterEquipOutstandingElementPrefix = "tdWATER_EQUIP_RI_RESERVE_";
			...
			{		
				...
				Sum = CalculateTotal(Section1Prefix,AmountElementPrefix) + CalculateTotal(Section2Prefix,AmountElementPrefix) + CalculateTotal(ScheduledItemsCoveragePrefix,ScheduledAmountElementPrefix) + CalculateTotal(WatercraftCoveragesPrefix,AmountElementPrefix) + CalculateTotal(RecVehCoveragePrefix,AmountElementPrefix) + CalculateTotal(WaterEquipItemsCoveragePrefix,WaterEquipPaymentPrefix);								
				//Sum = CalculateTotal(Section1Prefix,AmountElementPrefix) + CalculateTotal(Section2Prefix,AmountElementPrefix);								
			...
			function CompareAllOutstandingAndPayment()
			{
				...
				for(i=2;i<=Section1Rows;i++)
				{
					...
					txtPaymentID = Section1Prefix + i + AmountElementPrefix;
				...
				for(i=2;i<=Section2Rows;i++)
				{
					...
					txtPaymentID = Section2Prefix + i + AmountElementPrefix
					if(!CompareOutstandingAndPayment(txtOutstandingID,txtPaymentID))
						return false;
				}		
				//Added for Itrack Issue 6635 on 29 Oct 09
				...
				for(var i=2;i<=RecVehCoverageRows;i++)
				{
					...
					txtPaymentID = RecVehCoveragePrefix + i + AmountElementPrefix;
					if(!CompareOutstandingAndPayment(txtOutstandingID,txtPaymentID))
						return false;
				}
				...
				for(var i=2;i<=WatercraftCoveragesRows;i++)
				{
					...
					txtPaymentID = WatercraftCoveragesPrefix + i + AmountElementPrefix;
					if(!CompareOutstandingAndPayment(txtOutstandingID,txtPaymentID))
						return false;
				}
			...
			{
				var Sum = parseFloat(0);								
				Sum = CalculateTotal(Section1Prefix,OutstandingElementPrefix) + CalculateTotal(Section2Prefix,OutstandingElementPrefix) +  CalculateTotal(ScheduledItemsCoveragePrefix,OutstandingElementPrefix) +  CalculateTotal(WatercraftCoveragesPrefix,OutstandingElementPrefix);																								
	...
	<body onload="Init();" MS_POSITIONING="GridLayout">
		<div class="pageContent" id="bodyHeight">
			<form id="Form1" method="post" runat="server">
					...
					<TR id="trBody" runat="server">
						<TD colSpan="4">
							<table cellSpacing="0" cellPadding="0" width="100%">	
								...
								<tr class="midcolora" id="trWatercraftCoveragesGridRow" runat="server">
									<td colSpan="4"><asp:datagrid id="dgWatercraftCoveragesGrid" runat="server" AutoGenerateColumns="False" Width="100%">
											...
											<Columns>
												...
												<asp:TemplateColumn HeaderText="Limit" ItemStyle-CssClass="midcolorr" ItemStyle-Width="15%">
													<ItemTemplate>
												...
												<asp:TemplateColumn HeaderText="Outstanding" ItemStyle-Width="20%">
													<ItemTemplate>	
												...
												<asp:TemplateColumn HeaderText="RI Reserve" ItemStyle-Width="15%">
													<ItemTemplate>
												...
												<asp:TemplateColumn HeaderText="Reinsurance Carrier" ItemStyle-Width="15%">
													<ItemTemplate>
														<asp:Label ID="lblREINSURANCE_CARRIER"  Runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.REINSURANCECARRIER") >'></asp:Label>
												...
												<asp:TemplateColumn HeaderText="Recovery Amount" ItemStyle-Width="10%">
													<ItemTemplate>
														<asp:TextBox ID="txtAMOUNT"  Runat="server" MaxLength="14" CssClass="INPUTCURRENCY" ></asp:TextBox><br>
								...
								<tr id="trRecVehCoveragesGridRow" runat="server">
									<td class="midcolora" colSpan="4"><asp:datagrid id="dgRecVehCoveragesGrid" runat="server" AutoGenerateColumns="False" Width="100%">
											...
											<Columns>
												...
												<asp:TemplateColumn HeaderText="Reinsurance Carrier" ItemStyle-Width="15%">
													<ItemTemplate>
														<asp:Label ID="lblREINSURANCE_CARRIER"  Runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.REINSURANCE_CARRIER") %>'></asp:Label>
														<%--<asp:DropDownList ID="cmbREINSURANCE_CARRIER" Runat="server"></asp:DropDownList>--%>
													</ItemTemplate>
												</asp:TemplateColumn>
												<%--<asp:TemplateColumn HeaderText="MCCA Attachment Point" ItemStyle-Width="10%">
									...
									<td class="midcolora" colSpan="3">
										<table width="100%" border="0" >
											<tr>
												...
												<TD width="40%"><asp:textbox  id="txtTOTAL_RI_RESERVE" class="midcolora" Runat="server" ReadOnly="True" BorderWidth="0" size="15"
														BorderStyle="None"></asp:textbox></TD>																								
				...
				<INPUT id="hidScheduledRecrID" type="hidden" value="" name="hidScheduledRecrID" runat="server">	
				...
				<INPUT id="hidWaterEquipRecrID" type="hidden" value="" name="hidWaterEquipRecrID" runat="server">
