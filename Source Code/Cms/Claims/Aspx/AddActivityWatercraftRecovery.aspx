...
<%@ Page language="c#" Codebehind="AddActivityWatercraftRecovery.aspx.cs" AutoEventWireup="false" Inherits="Cms.Claims.Aspx.AddActivityWatercraftRecovery" %>
...
<HTML>
  <HEAD>
		...
		<script language="javascript">
			...
			{		
				var Sum = parseFloat(0);				
				Sum = CalculateTotal(PolicyPrefix,PaymentPrefix) + CalculateTotal(VehiclePrefix,PaymentPrefix)+  CalculateTotal(WaterEquipCoveragePrefix,WaterEquipPaymentPrefix);								
    ...
    <TD colspan="4">
				<table cellSpacing="0" cellPadding="0" WIDTH="100%">
								...
								<tr id="trVehiclePayment" runat="server">
									<TD class="headerEffectSystemParams" colSpan="4">Boat Level Recovery</TD>
								</tr>
								<tr>
								...
								<tr class="midcolora" id="trTotalPayments" runat="server">
									...
									<td class="midcolora" colSpan="3">
										<table width="100%" border="0" >
											<tr>
												<td width="41%"></td>
												<TD width="14%"><asp:textbox class="midcolora" id="txtTOTAL_OUTSTANDING" Runat="server" ReadOnly="True" BorderWidth="0"  size="15"
														BorderStyle="None"></asp:textbox></TD>
												<TD width="29%"><asp:textbox  id="txtTotalRI_Reserve" class="midcolora" Runat="server" ReadOnly="True" BorderWidth="0" size="15"
														BorderStyle="None"></asp:textbox></TD>																								
