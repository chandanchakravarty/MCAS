...
<%@ Page language="c#" Codebehind="ClearClaimsCheck.aspx.cs" AutoEventWireup="false" Inherits="Claims.Aspx.ClearClaimsCheck" %>
...
<HTML>
	<HEAD>
		...
		function ClearClaimCheck()
		{
			...
			{
				alert("Please select atleast one check for clearing");
				return false;
			}
			else
			{
