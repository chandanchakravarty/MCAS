...
<%@ Page language="c#" validateRequest=false Codebehind="PaymentDetails.aspx.cs" AutoEventWireup="false" Inherits="Cms.Claims.Aspx.PaymentDetails" %>
...
<tr>
	<TD id="tdClaimTop" class="pageHeader" colSpan="4">
		<webcontrol:ClaimTop id="cltClaimTop" runat="server" width="100%"></webcontrol:ClaimTop>
					...
					<tr>
						<td align="center" colspan="4" class="midcolorc"><asp:label id="lblMessage" runat="server" EnableViewState="False" Visible="False" CssClass="errmsg"></asp:label></td>
					</tr>
											...
											<Columns>
												...
												<asp:TemplateColumn HeaderText="Limit" ItemStyle-Width="10%">
													<ItemTemplate>
														...
														<asp:Label ID="lblPAYMENT_ID" Runat="server" Visible="False" Text='<%# DataBinder.Eval(Container, "DataItem.PAYMENT_ID") %>'>
														</asp:Label>
												...
												<asp:TemplateColumn HeaderText="Payment Amount" ItemStyle-Width="10%">
													<ItemTemplate>
														...
														<asp:RangeValidator ID="rngPAYMENT_AMOUNT" MinimumValue="1" MaximumValue="9999999999" Type="Currency" Runat="server" Display="Dynamic" ControlToValidate="txtPAYMENT_AMOUNT" Enabled="False"></asp:RangeValidator>
													</ItemTemplate>
												</asp:TemplateColumn>
											</Columns>
										</asp:datagrid></td>
									...
									<td class="midcolora" colSpan="3">
										<table width="100%" border="0">
											<tr>
												...
												<TD width="59%"><asp:textbox class="midcolora" id="txtTOTAL_OUTSTANDING" size="15" BorderStyle="None" BorderWidth="0"
														ReadOnly="True" Runat="server"></asp:textbox></TD>
												<TD><asp:textbox class="midcolora" id="txtTOTAL_PAYMENT" size="15" BorderStyle="None" BorderWidth="0"
														ReadOnly="True" Runat="server"></asp:textbox></TD>
											</tr>
										</table>
									</td>
