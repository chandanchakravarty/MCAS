<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ClaimCoveragesIndex.aspx.cs" Inherits="Cms.Claims.Aspx.ClaimCoveragesIndex" %>
...
<body oncontextmenu="return false;" leftMargin="0" topMargin="0" rightMargin="0" onload="setfirstTime();top.topframe.main1.mousein = false;findMouseIn();">
    ...
    <table class="tableWidthHeader" cellSpacing="0" cellPadding="0" border="0">
					<tr>						
						...
						<input type="hidden" id="hidCO_INSURANCE_TYPE" name="hidCO_INSURANCE_TYPE" runat="server">		
						<input type="hidden" id="hidLITIGATION_FILE" name="hidLITIGATION_FILE" runat="server">		
						<input type="hidden" id="hidIS_VICTIM_CLAIM" name="hidIS_VICTIM_CLAIM" runat="server">	
						<input type="hidden" id="hidALLOW_ADD_COVERAGE" name="hidALLOW_ADD_COVERAGE" runat="server">		
						<input type="hidden" id="hidACC_COI_FLG" name="hidACC_COI_FLG" runat="server">	
