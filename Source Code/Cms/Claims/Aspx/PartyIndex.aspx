...
<%@ Page language="c#" Codebehind="PartyIndex.aspx.cs" AutoEventWireup="false" Inherits="Cms.Claims.Aspx.PartyIndex" %>
...
<HTML>
	<HEAD>
		...
		function Init()
		{
			...
			if(document.getElementById("hidAddNew").value=="1")
	...
	<body oncontextmenu="return false;" onload="Init();" MS_POSITIONING="GridLayout">
		...
		<!--Modified according to the Property Damaged ID : Sep 28 2007-->
		...
		<%}%>
				...
				<tr>
					<td>
						...
						<INPUT id="hidAddNew" type="hidden" value="0" name="hidAddNew" runat="server"> 
