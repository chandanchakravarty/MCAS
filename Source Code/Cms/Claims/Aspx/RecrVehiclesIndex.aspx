<%@ Page language="c#" Codebehind="RecrVehiclesIndex.aspx.cs" AutoEventWireup="false" Inherits="Cms.Claims.Aspx.RecrVehiclesIndex" %>
				...
				<table class="tableWidthHeader" cellSpacing="0" cellPadding="0" border="0">
					<tr>						
						<td>						
								...
								<tr>
									<td>
										<table class="tableWidthHeader" cellSpacing="0" cellPadding="0" align="center" border="0">
											<tr id="tabCtlRow">
												<td>
													<webcontrol:tab id="TabCtl" runat="server" TabLength="150" TabTitles="RV Information"></webcontrol:tab>
												</td>
											</tr>
											<tr>
												<td>
							...
							<input type="hidden" name="hidCLAIM_ID" runat="server" id="Hidden1">
							<input type="hidden" name="hidlocQueryStr" id="hidlocQueryStr"> <input type="hidden" name="hidMode">						
							<INPUT id="hidCLAIM_ID" type="hidden" runat="server" NAME="hidCLAIM_ID">
							<INPUT id="hidLOB_ID" type="hidden" runat="server" NAME="hidLOB_ID">
						</td>
					</tr>
				</table>
			</form>
