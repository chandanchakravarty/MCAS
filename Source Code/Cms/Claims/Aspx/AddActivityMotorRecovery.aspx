<%@ Page language="c#" validateRequest=false Codebehind="AddActivityMotorRecovery.aspx.cs" AutoEventWireup="false" Inherits="Cms.Claims.Aspx.AddActivityMotorRecovery" %>
								...
								<tr class="midcolora" id="trTotalPayments" runat="server">
									...
									<td class="midcolora" colSpan="3">
										<table width="100%" border="0" >
											<tr>
												<td width="40%"></td>
												<TD width="15%">&nbsp;<asp:textbox class="midcolora" id="txtTOTAL_OUTSTANDING" Runat="server" ReadOnly="True" BorderWidth="0"  size="15"
														BorderStyle="None"></asp:textbox></TD>
												<TD width="30%"><asp:textbox  id="txtTotalRI_Reserve" class="midcolora" Runat="server" ReadOnly="True" BorderWidth="0" size="15"
														BorderStyle="None"></asp:textbox></TD>																								
