...
<%@ Page language="c#" validateRequest=false Codebehind="ReserveMotorDetails.aspx.cs" AutoEventWireup="false" Inherits="Cms.Claims.Aspx.ReserveMotorDetails" %>
							...
							<table cellSpacing="0" cellPadding="0" width="100%">
									...
									<td class="midcolora" colSpan="4"><asp:datagrid id="dgPolicyCoverages" runat="server" Width="100%" AutoGenerateColumns="False">
											...
											<Columns>
												...
												<%--<asp:TemplateColumn HeaderText="Paid Loss" ItemStyle-Width="5%">
													<ItemTemplate>														
														<asp:TextBox ID="txtPRIMARY_EXCESS" Runat="server" size="10" MaxLength="10" Text='<%# DataBinder.Eval(Container, "DataItem.PRIMARY_EXCESS") >'>></asp:TextBox><br>
														<asp:RangeValidator ID="rngPRIMARY_EXCESS" MinimumValue="1" MaximumValue="9999999999" Type="Currency" Runat="server"
															Display="Dynamic" ControlToValidate="txtPRIMARY_EXCESS"></asp:RangeValidator>
													</ItemTemplate>
												</asp:TemplateColumn>--%>
								...
								<tr id="trVehicleGridRow" runat="server">
									<td class="midcolora" colSpan="4"><asp:datagrid id="dgCoverages" runat="server" Width="100%" AutoGenerateColumns="False">
											...
											<Columns>
												...
												<asp:TemplateColumn HeaderText="Attachment Point"  ItemStyle-Width="10%">
													<ItemTemplate>
								...
								<tr class="midcolora" id="trTotalRow" runat="server">
									...
									<td colSpan="3">
										<table width="100%" border="0">
											<tr>
												<td width="45%">&nbsp;</td>
												<TD width="18%"><asp:textbox class="midcolora" id="txtTOTAL_OUTSTANDING" Runat="server" ReadOnly="True" BorderWidth="0" size="20"
														BorderStyle="None"></asp:textbox></TD>
												<TD width="37%"><asp:textbox id="txtTOTAL_RI_RESERVE" class="midcolora" Runat="server" ReadOnly="True" BorderWidth="0"
														size="20" BorderStyle="None"></asp:textbox></TD>
												<TD style="display:none">&nbsp;<asp:textbox id="Textbox7" class="midcolora" Runat="server" ReadOnly="True" BorderWidth="0" Width="50px"
														BorderStyle="None"></asp:textbox></TD>
											</tr>
										</table>
									</td>
								...
								<tr>
									...
									<asp:RegularExpressionValidator ID="revRECOVERY" ControlToValidate="txtRECOVERY" Display="Dynamic" Runat="server" Type="Currency"></asp:RegularExpressionValidator>
										<asp:rangevalidator id="rngRECOVERY" Runat="server" ControlToValidate="txtRECOVERY" Display="Dynamic"
