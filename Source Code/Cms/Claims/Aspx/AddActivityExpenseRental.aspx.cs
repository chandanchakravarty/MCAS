...
namespace Cms.Claims.Aspx
{
	...
	/// </summary>
	public class AddActivityExpenseRental : Cms.Claims.ClaimBase
	{
...
//		public DataTable gDtOldData=null;
		...
		private void Page_Load(object sender, System.EventArgs e)
		{
			...
			objResourceMgr = new System.Resources.ResourceManager("Cms.Claims.Aspx.AddActivityExpenseRental"  ,System.Reflection.Assembly.GetExecutingAssembly());
...
//					dsOldData.Tables[i].Columns.Add(dtCol);
			...
			else
			{
				...
				if(dsOldData.Tables[0].Rows.Count>1)
					hidOldData.Value = Cms.BusinessLayer.BlCommon.ClsCommon.GetXMLEncoded(dsOldData.Tables[0]);
				else
			...
			foreach(DataGridItem dgi in dtGrid.Items)
			{
				if ( dgi.ItemType == ListItemType.Item || dgi.ItemType == ListItemType.AlternatingItem )
				{
					...
					if(lblDWELLING_ID!=null && lblDWELLING_ID.Text.Trim()!="")
						objActivityExpenseInfo.VEHICLE_ID = int.Parse(lblDWELLING_ID.Text.Trim());
