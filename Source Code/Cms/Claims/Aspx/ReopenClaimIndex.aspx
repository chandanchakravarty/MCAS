<%@ Page language="c#" Codebehind="ReopenClaimIndex.aspx.cs" AutoEventWireup="false" Inherits="Cms.Claims.Aspx.ReopenClaimIndex" %>
...
<HTML>
	<HEAD>
		...
		function Init()
		{
			...
			findMouseIn();
			var ReopenCookieValue = readCookie('AddNewReopenClaim');
			if(ReopenCookieValue!=null && ReopenCookieValue=='1')
			{
				setTimeout('addRecord()',1000);
			}
			eraseCookie('AddNewReopenClaim');									
		}			
