<%@ Page language="c#" Codebehind="OwnerDetailsIndex.aspx.cs" AutoEventWireup="false" Inherits="Cms.Claims.Aspx.OwnerDetailsIndex" %>
				...
				<table class="tableWidthHeader" cellSpacing="0" cellPadding="0" border="0">
					<tr>						
						<td>						
							...
							<input type="hidden" name="hidTYPE_OF_HOME" id="hidTYPE_OF_HOME" runat="server">
