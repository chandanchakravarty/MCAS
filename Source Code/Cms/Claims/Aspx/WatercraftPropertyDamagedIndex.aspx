<%@ Page language="c#" Codebehind="WatercraftPropertyDamagedIndex.aspx.cs" AutoEventWireup="false" Inherits="Cms.Claims.Aspx.WatercraftPropertyDamagedIndex" %>
								...
								<tr>
									<td>
										<table class="tableWidthHeader" cellSpacing="0" cellPadding="0" align="center" border="0">
											<tr id="tabCtlRow">
												<td>
													<webcontrol:tab id="TabCtl" runat="server" TabLength="150" TabTitles="Property Damaged"></webcontrol:tab>
												</td>
											</tr>
											<tr>
												<td>
