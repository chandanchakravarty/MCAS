...
<%@ Page language="c#" Codebehind="PayeeIndex.aspx.cs" AutoEventWireup="false" Inherits="Cms.Claims.Aspx.PayeeIndex" %>
				...
				<table class="tableWidthHeader" cellSpacing="0" cellPadding="0" border="0">
					<tr>						
						<td>						
							...
							<input type="hidden" name="hidIS_PAYMENT_EXPENSE" runat="server" id="hidIS_PAYMENT_EXPENSE"> 
