<%@ Page language="c#" Codebehind="InsuredVehicleIndex.aspx.cs" AutoEventWireup="false" Inherits="Cms.Claims.Aspx.InsuredVehicleIndex" %>
				...
				<table class="tableWidthHeader" cellSpacing="0" cellPadding="0" border="0">
					<tr>						
						<td>						
							...
							<input type="hidden" name="hidLOB_ID" runat="server" id="hidLOB_ID"> 
