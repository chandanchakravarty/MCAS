<%@ Page language="c#" Codebehind="PaymentRentalDetails.aspx.cs" AutoEventWireup="false" Inherits="Cms.Claims.Aspx.PaymentRentalDetails" %>
  ...
  <HEAD>
		...
		<script language="javascript">
			...
			{		
				...
				//alert("Hi  " + document.getElementById("txtTOTAL_PAYMENT").value);
			}
				...
				<table cellSpacing="0" cellPadding="0" WIDTH="100%">
								...
								<tr>
									<td class="midcolora" colspan="4">
										<asp:datagrid id="dgSection1Payment" runat="server" AutoGenerateColumns="False"
											Width="100%">
								...
								<tr>
									<td class="midcolora" colspan="4">
										<asp:datagrid id="dgSection2Payment" runat="server" AutoGenerateColumns="False"
											Width="100%">
											<AlternatingItemStyle CssClass="midcolora"></AlternatingItemStyle>
											<ItemStyle CssClass="midcolora"></ItemStyle>
											<HeaderStyle CssClass="headereffectWebGrid"></HeaderStyle>
									...
									<td class="midcolora" colSpan="3">
										<table width="100%" border="0" >
											<tr>
												...
												<TD width="37%"><asp:textbox class="midcolora" id="txtTOTAL_OUTSTANDING" Runat="server" ReadOnly="True" BorderWidth="0"  size="15"
