...
namespace Cms.Claims.Aspx
{
	...
	/// 
	/// </summary>
	public class ActivityExpenseTab : Cms.Claims.ClaimBase
	{
		...
		{
			string url;					
			url = "AddActivityExpense.aspx?CLAIM_ID=" + hidCLAIM_ID.Value + "&ACTIVITY_ID=" + hidACTIVITY_ID.Value + "&ACTION_ON_PAYMENT=" + hidACTION_ON_PAYMENT.Value + "&";
			TabCtl.TabURLs = url;
			...
			TabCtl.TabTitles  = "Expense Payment";
		}
