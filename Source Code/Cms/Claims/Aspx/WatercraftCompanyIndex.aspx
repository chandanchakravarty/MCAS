<%@ Page language="c#" Codebehind="WatercraftCompanyIndex.aspx.cs" AutoEventWireup="false" Inherits="Cms.Claims.Aspx.WatercraftCompanyIndex" %>
				...
				<table class="tableWidthHeader" cellSpacing="0" cellPadding="0" border="0">
					<tr>						
						<td>						
							...
							<input type="hidden" name="hidAGENCY_ID" runat="server" id="hidAGENCY_ID">
