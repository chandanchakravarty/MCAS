<%@ Page language="c#" Codebehind="InsuredBoatIndex.aspx.cs" AutoEventWireup="false" Inherits="Cms.Claims.Aspx.InsuredBoatIndex" %>
								...
								<tr>
									<td>
										<table class="tableWidthHeader" cellSpacing="0" cellPadding="0" align="center" border="0">
											<tr id="tabCtlRow">
												<td>
													<webcontrol:tab id="TabCtl" runat="server" TabLength="150" TabTitles="Insured Boat"></webcontrol:tab>
												</td>
											</tr>
											<tr>
												<td>
