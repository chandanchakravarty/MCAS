/******************************************************************************************
	...
	<End Date				: - >
	<Description			: - A wrapper to SqlHelper, which will handle transaction>
	<Review Date			: - >
	<Reviewed By			: - >
...
namespace Cms.EbixDataLayer
{
	...
	{
		//:Static variable to specifify CommandTimeOut it will defaulted to 0 (which will 
		//override default value 30). In BusinessLayer if a different timeout is to be specified it can be done
		//Using property CommandTimeOut exposed by ClsDataWrapper.
		//If value of CommandTimeOut is altered datalayer will use new value through out the application domain 
		// as it is static member. Make sure to reset it if it all required to be changed

		protected static int mCommandTimeOut = 0 ;
		...
		public static void PrepareCommand(SqlCommand command, SqlConnection connection, SqlTransaction transaction, CommandType commandType, string commandText, SqlParameter[] commandParameters, out bool mustCloseConnection )
		{
			...
			//Ravindra(07-02-2008): Override default command time out
