...
{
	/// <summary>
	/// Database Model for CLM_ACTIVITY_PAYMENT.
	/// </summary>
	public class ClsPaymentInfo : Cms.Model.ClsCommonModel
	{
		private const string CLM_ACTIVITY_PAYMENT = "CLM_ACTIVITY_PAYMENT";
		public ClsPaymentInfo()
		{
			base.dtModel.TableName = "CLM_ACTIVITY_PAYMENT";		// setting table name for data table that holds property values.
			this.AddColumns();								// add columns of the database table CLM_ACTIVITY_PAYMENT
			base.dtModel.Rows.Add(base.dtModel.NewRow());	// add a blank row in the datatable
		}
		private void AddColumns()
		{
			base.dtModel.Columns.Add("CLAIM_ID",typeof(int));
			base.dtModel.Columns.Add("PAYMENT_ID",typeof(int));
		...
		// model for database field PAYMENT_ID(int)
		public int PAYMENT_ID
		{
			get
			{
				return base.dtModel.Rows[0]["PAYMENT_ID"] == DBNull.Value ? 0 : int.Parse(base.dtModel.Rows[0]["PAYMENT_ID"].ToString());
			}
			set
			{
				base.dtModel.Rows[0]["PAYMENT_ID"] = value;
			}
		}
