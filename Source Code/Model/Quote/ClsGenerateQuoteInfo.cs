/******************************************************************************************
<Author				: -   Nidhi
<Start Date				: -	7/8/2005 11:32:19 AM
<End Date				: -	
<Description				: - 	model class for saving quote 
<Review Date				: - 
<Reviewed By			: - 	
...
{
	/// <summary>
	/// Database Model for QOT_CUSTOMER_QUOTE_LIST.
	/// </summary>
	public class ClsGenerateQuoteInfo : Cms.Model.ClsCommonModel 
	{
		private const string QOT_CUSTOMER_QUOTE_LIST = "QOT_CUSTOMER_QUOTE_LIST";
		public ClsGenerateQuoteInfo()
		{
