...
<End Date			: -	
<Description		: - Model class for POL_MARINE_CARGO_GEN_INFO table
<Review Date		: - 
<Reviewed By		: - 	
*******************************************************************************************/
...
{
    public class ClsPolicyUWQMarineInfo : Cms.Model.ClsCommonModel
    {
        string strCalledFrom = "";
        private const string POL_MARINE_CARGO_GEN_INFO = "POL_MARINE_CARGO_GEN_INFO";
        public ClsPolicyUWQMarineInfo()
        {
            base.dtModel.TableName = POL_MARINE_CARGO_GEN_INFO;		// setting table name for data table that holds property values.
            this.AddColumns();										// add columns of the database table POL_MARINE_CARGO_GEN_INFO
