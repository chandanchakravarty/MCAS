...
{
    [Serializable]
    public class ClsPolicyBillingInfo : ClsModelBaseClass, IDisposable
    {

        public ClsPolicyBillingInfo()
        {
            PropertyCollection();
        }
        public  void Dispose() 
            ...
            try
            {
                if (objClsPolicyBillingInfoList.Count > 0)
                {
                    ...
                    for (int i = 0; i < objClsPolicyBillingInfoList.Count; i++)
                    {
                        ...
                        objBillingInfo = (ClsPolicyBillingInfo)objClsPolicyBillingInfoList[i];
        ...
        public int UpdateInstallments(ArrayList ArobjClsPolicyBillingInfo)
        {
            ...
            try
            {
                if (ArobjClsPolicyBillingInfo.Count > 0)
                {
                    ...
                    {
                        ClsPolicyBillingInfo objBillingInfo = new ClsPolicyBillingInfo();
                        objBillingInfo = (ClsPolicyBillingInfo)ArobjClsPolicyBillingInfo[i];
                        ...
                        {
                            ClsPolicyBillingInfo objBillingInfoo = new ClsPolicyBillingInfo();
                            objBillingInfoo = (ClsPolicyBillingInfo)ArobjClsPolicyBillingInfo[i];
                            strTranXML = "";
                            objDataWrapper.ClearParameteres();
        ...
        private int SaveUpdateInstallmentDetailsHistory(ClsPolicyBillingInfo objInfo,DataWrapper objDataWrapper, out string strTranXML)
        {
        ...
        private int UpdateInstallment(ClsPolicyBillingInfo objInfo, string ProcName, DataWrapper objDataWrapper, out string strTranXML)
        {
        ...
        private int UpdatePlanDataForBoletoReprint(ClsPolicyBillingInfo objInfo, string ProcName, DataWrapper objDataWrapper, out string strTranXML)
        {
            int returnResult = 0;
        ...
        private int UpdatePlanData(ClsPolicyBillingInfo objInfo, string ProcName, DataWrapper objDataWrapper, out string strTranXML)
        {
            int returnResult = 0;
