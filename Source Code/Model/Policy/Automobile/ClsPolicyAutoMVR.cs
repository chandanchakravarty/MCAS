/******************************************************************************************
<Author				: -   Anurag Verma
<Start Date				: -	11/8/2005 12:58:48 PM
<End Date				: -	
<Description				: - 	Model Class for Policy Auto MVR
<Review Date				: - 
<Reviewed By			: - 	
...
{
	/// <summary>
	/// Summary description for ClsPolicyAutoMVR.
	/// </summary>
	public class ClsPolicyAutoMVR : Cms.Model.ClsCommonModel
	{
		private const string POL_MVR_INFORMATION = "POL_MVR_INFORMATION";
		public ClsPolicyAutoMVR()
		{
			base.dtModel.TableName = "POL_MVR_INFORMATION";		// setting table name for data table that holds property values.
		...
		private void AddColumns()
		{
			...
			base.dtModel.Columns.Add("POL_WATER_MVR_ID",typeof(int));
			base.dtModel.Columns.Add("POL_UMB_MVR_ID",typeof(int));
		...
		public int POL_WATER_MVR_ID
		{
			get
			{
				return base.dtModel.Rows[0]["POL_WATER_MVR_ID"] == DBNull.Value ? 0 : int.Parse(base.dtModel.Rows[0]["POL_WATER_MVR_ID"].ToString());
			}
			set
			{
				base.dtModel.Rows[0]["POL_WATER_MVR_ID"] = value;
			}
		}
		...
		// model for database field VIOLATION_TYPE(int)
		...
		public int POL_UMB_MVR_ID
		{
			get
			{
				return base.dtModel.Rows[0]["POL_UMB_MVR_ID"] == DBNull.Value ? 0 : int.Parse(base.dtModel.Rows[0]["POL_UMB_MVR_ID"].ToString());
			}
			set
			{
				base.dtModel.Rows[0]["POL_UMB_MVR_ID"] = value;
			}
		}
