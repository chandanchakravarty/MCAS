...
namespace Cms.Model.Policy
{
	...
	/// <summary>
	/// Database Model for POL_UNDERWRITING_TIER.
	/// </summary>
	public class ClsUnderwritingTierInfo : Cms.Model.ClsCommonModel
	{
		private const string POL_AUTO_GEN_INFO = "POL_UNDERWRITING_TIER";
		public ClsUnderwritingTierInfo()
		{
			...
			this.AddColumns();								// add columns of the database table POL_UNDERWRITING_TIER
