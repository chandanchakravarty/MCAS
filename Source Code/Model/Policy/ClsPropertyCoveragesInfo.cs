...
{
    [Serializable]
   public class ClsPropertyCoveragesInfo : Cms.Model.ClsCommonModel
    {
        public ClsPropertyCoveragesInfo()
        {
            base.dtModel.TableName = "POL_BOP_LIABILITY_COVERAGE";
            this.AddColumns();
        ...
        private void AddColumns()
        {
            ...
            base.dtModel.Columns.Add("COV_TYPE", typeof(string));
        ...
        public int PREMISES_ID
        {
            get
            {
                return base.dtModel.Rows[0]["PREMISES_ID"] == DBNull.Value ? -1 : int.Parse(base.dtModel.Rows[0]["PREMISES_ID"].ToString());
            }
            set
            {
        ...
        public string COV_TYPE
        {
            get
            {
                return base.dtModel.Rows[0]["COV_TYPE"] == DBNull.Value ? Convert.ToString(null) : (base.dtModel.Rows[0]["COV_TYPE"].ToString());
            }
            set
            {
                base.dtModel.Rows[0]["COV_TYPE"] = value;
            }
        }
