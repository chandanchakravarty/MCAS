...
<End Date			: -	
<Description		: - Model class for POL_DWELLING_SECTION_COVERAGES
<Review Date		: - 
<Reviewed By		: - 	
*******************************************************************************************/ 
...
{
	/// <summary>
	/// Summary description for ClsPolicyDwellingSectionCoveragesInfo.
	/// </summary>
	public class ClsPolicyDwellingSectionCoveragesInfo : Cms.Model.ClsCommonModel 
	{
		
		public ClsPolicyDwellingSectionCoveragesInfo()
		{
			//
