...
namespace Cms.Model.Policy.Homeowners
{
	...
	/// </summary>
	public class ClsPolicyDwellingDetailsInfo : Cms.Model.ClsCommonModel
	{

		private const string POL_DWELLINGS_INFO = "pol_DWELLINGS_INFO";
		private ArrayList alAdditionalInterest;
		//private Cms.Model.Application.ClsHomeConstructionInfo  objHomeConstruction;
		//private ClsProtectDevicesInfo objProtectInfo;
		//private ClsDwellingCoverageLimitInfo objCovg;
		//private Cms.Model.Application.HomeOwners.ClsHomeRatingInfo  objHomeRatingInfo;
        
		private ArrayList alCoverages;

		public ClsPolicyDwellingDetailsInfo()
		{
			base.dtModel.TableName = "POL_DWELLINGS_INFO";		// setting table name for data table that holds property values.
			this.AddColumns();								// add columns of the database table pol_DWELLINGS_INFO
        ...
        */
        ...
        //}
        /*
		public Cms.Model.Application.HomeOwners.ClsHomeRatingInfo GetHomeRating()
		{
			return objHomeRatingInfo;
		}

		public void SetHomeRating(Cms.Model.Application.HomeOwners.ClsHomeRatingInfo objInfo)
		{
			objHomeRatingInfo = objInfo;
		}*/

//		public Cms.Model.Application.ClsHomeConstructionInfo GetHomeConstruction()
//		{
//			return objHomeConstruction;
//		}
//		
//		public void SetHomeConstruction(Cms.Model.Application.ClsHomeConstructionInfo objInfo)
//		{
