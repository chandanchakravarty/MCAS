...
<End Date				: -	
<Description			: -  Model class for POL_UMBRELLA_RECREATIONAL_VEHICLES
...
{
	/// <summary>
	/// Database Model for POL_UMBRELLA_RECREATIONAL_VEHICLES.
	/// </summary>
	public class ClsRecrVehiclesInfo : Cms.Model.ClsCommonModel
	{
		private const string POL_UMBRELLA_RECREATIONAL_VEHICLES = "POL_UMBRELLA_RECREATIONAL_VEHICLES";
		public ClsRecrVehiclesInfo()
		{
			base.dtModel.TableName = "POL_UMBRELLA_RECREATIONAL_VEHICLES";		// setting table name for data table that holds property values.
			this.AddColumns();								// add columns of the database table POL_UMBRELLA_RECREATIONAL_VEHICLES
