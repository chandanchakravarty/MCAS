...
{
	/// <summary>
	/// Database Model for POL_UMBRELLA_WATERCRAFT_ENGINE_INFO.
	/// </summary>
	public class ClsWaterCraftEngineInfo : Cms.Model.ClsCommonModel
	{
		private const string POL_UMBRELLA_WATERCRAFT_ENGINE_INFO = "POL_UMBRELLA_WATERCRAFT_ENGINE_INFO";
		public ClsWaterCraftEngineInfo()
		{
			base.dtModel.TableName = "POL_UMBRELLA_WATERCRAFT_ENGINE_INFO";		// setting table name for data table that holds property values.
			this.AddColumns();								// add columns of the database table POL_UMBRELLA_WATERCRAFT_ENGINE_INFO
