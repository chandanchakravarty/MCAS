...
<End Date				: -	
<Description			: -  Model Class for POL_UMBRELLA_DWELLINGS_INFO
<Review Date			: - 
<Reviewed By			: - 	
...
namespace Cms.Model.Policy.Umbrella
{
	...
	/// </summary>
	public class ClsDwellingInfo : Cms.Model.ClsCommonModel
	{

		#region Constructor
		public ClsDwellingInfo()
		{
			base.dtModel.TableName ="POL_UMBRELLA_DWELLING_INFO";
			this.AddColumns();
		...
		#region Private Function--- AddColumns
