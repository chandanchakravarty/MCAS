...
<End Date				: -	
<Description			: -  Model class for Policy Umbrella Gen Info
<Review Date			: - 
<Reviewed By			: - 	
...
{
	/// <summary>
	/// Database Model for POL_UMBRELLA_GEN_INFO.
	/// </summary>
	public class ClsUmbrellaGenInfo : Cms.Model.ClsCommonModel
	{
		private const string POL_UMBRELLA_GEN_INFO = "POL_UMBRELLA_GEN_INFO";
		
		public ClsUmbrellaGenInfo()
		{
			base.dtModel.TableName = "POL_UMBRELLA_GEN_INFO";		// setting table name for data table that holds property values.
			this.AddColumns();								// add columns of the database table POL_UMBRELLA_GEN_INFO
