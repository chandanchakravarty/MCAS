...
<End Date				: -	
<Description				: - 	Model Class for Policy Umbrella Driver/Operator
<Review Date				: - 
<Reviewed By			: - 	
...
namespace Cms.Model.Policy.Umbrella
{
	...
	/// </summary>
	public class ClsDriverOperatorInfo : Cms.Model.ClsCommonModel
	{
		private const string POL_DRIVER_DETAILS = "POL_DRIVER_DETAILS";
		public ClsDriverOperatorInfo()
		{
			base.dtModel.TableName = "POL_UMBRELLA_DRIVER_DETAILS";		// setting table name for data table that holds property values.
			this.AddColumns();								// add columns of the database table POL_UMBRELLA_DRIVER_DETAILS
