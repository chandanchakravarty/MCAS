/******************************************************************************************
<Author				: -   nidhi
<Start Date				: -	5/18/2005 11:51:13 AM
<End Date				: -	
<Description				: - 	model class for watercraft operator
<Review Date				: - 
<Reviewed By			: - 	
Modification History
<Modified Date			: -  22/09/2005
<Modified By				: - Anurag verma
<Purpose				: - Removing DRIVER_TITLE,DRIVER_HOME_PHONE,DRIVER_MART_STAT,DATE_EXP_START properties and adding Experience_Credit property
...
{
	/// <summary>
	/// Database Model for APP_WATERCRAFT_DRIVER_DETAILS.
	/// </summary>
	public class ClsWatercraftOperatorInfo : Cms.Model.ClsCommonModel
	{
		private const string APP_WATERCRAFT_DRIVER_DETAILS = "APP_WATERCRAFT_DRIVER_DETAILS";
		public ClsWatercraftOperatorInfo()
		{
			base.dtModel.TableName = "APP_WATERCRAFT_DRIVER_DETAILS";		// setting table name for data table that holds property values.
			this.AddColumns();								// add columns of the database table APP_WATERCRAFT_DRIVER_DETAILS
		...
		private void AddColumns()
		{
			...
			base.dtModel.Columns.Add("DRIVER_SEX_CODE",typeof(string));
			...
			//Years Licensed
			base.dtModel.Columns.Add("YEARS_LICENSED",typeof(int));
		...
		// model for database field DRIVER_SEX(string)
		public string DRIVER_SEX_CODE
		{
			get
			{
				return base.dtModel.Rows[0]["DRIVER_SEX_CODE"] == DBNull.Value ? Convert.ToString(null) : base.dtModel.Rows[0]["DRIVER_SEX_CODE"].ToString();
			}
			set
			{
				base.dtModel.Rows[0]["DRIVER_SEX_CODE"] = value;
			}
		}
		...
		// model for database field YEARS_LICENSED(int)
		public int YEARS_LICENSED
		{
			get
			{
				return base.dtModel.Rows[0]["YEARS_LICENSED"] == DBNull.Value ? -1 : Convert.ToInt32(base.dtModel.Rows[0]["YEARS_LICENSED"].ToString());
			}
			set
			{
				base.dtModel.Rows[0]["YEARS_LICENSED"] = value;
			}
		}
