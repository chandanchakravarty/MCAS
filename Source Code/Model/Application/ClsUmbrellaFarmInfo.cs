...
<End Date				: -	
<Description			: -   Models APP_UMBRELLA_FARM_INFO
<Review Date			: - 
<Reviewed By			: - 	
...
namespace Cms.Model.Application
{
	...
	/// </summary>
	public class ClsUmbrellaFarmInfo :Cms.Model.ClsCommonModel 
	{
		#region Constructor
		public ClsUmbrellaFarmInfo()
		{
			base.dtModel.TableName = "APP_UMBRELLA_FARM_INFO";
			AddColumns ();
