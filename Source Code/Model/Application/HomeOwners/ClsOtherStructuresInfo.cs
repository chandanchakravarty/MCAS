/******************************************************************************************
<Author				: -   Shafii
<Start Date				: -	6/23/2006 12:39:35 PM
<End Date				: -	
<Description				: - 	
<Review Date				: - 
<Reviewed By			: - 	
...
{
	/// <summary>
	/// Database Model for APP_OTHER_STRUCTURE_DWELLING.
	/// </summary>
	public class ClsOtherStructuresInfo : Cms.Model.ClsCommonModel
	{
		private const string APP_OTHER_STRUCTURE_DWELLING = "APP_OTHER_STRUCTURE_DWELLING";
		public ClsOtherStructuresInfo()
		{
			base.dtModel.TableName = "APP_OTHER_STRUCTURE_DWELLING";		// setting table name for data table that holds property values.
			this.AddColumns();								// add columns of the database table APP_OTHER_STRUCTURE_DWELLING
