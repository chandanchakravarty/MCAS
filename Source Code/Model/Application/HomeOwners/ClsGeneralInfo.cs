/******************************************************************************************
<Author				: - Anshuman
<Start Date			: -	5/18/2005 4:46:34 PM
<End Date			: -	
<Description		: - Model class for table APP_HOME_OWNER_GEN_INFO	
<Review Date		: - 
<Reviewed By		: - 	
...
<Modified Date		: - Mohit Gupta.
<Modified By		: - 18/10/2005
<Purpose			: - Adding fields NON_SMOKER_CREDIT.
...
{
	/// <summary>
	/// Database Model for APP_HOME_OWNER_GEN_INFO.
	/// </summary>
	public class clsGeneralInfo : Cms.Model.ClsCommonModel
	{
		...
		{
			base.dtModel.TableName = APP_HOME_OWNER_GEN_INFO;		// setting table name for data table that holds property values.
		...
		private void AddColumns()
		{
			...
			// Commented by Mohit
			//base.dtModel.Columns.Add("DESC_BUSINESS",typeof(string));
			...
			base.dtModel.Columns.Add("DOG_SURCHARGE",typeof(string));

			//Added IS_LOSS_FREE_12_MONTHS
			base.dtModel.Columns.Add("IS_LOSS_FREE_12_MONTHS",typeof(string));
			base.dtModel.Columns.Add("EXP_AGE_CREDIT",typeof(int));
			// end
			//Added NO_OF_YEARS_INSURED : 9 Feb 2006
			base.dtModel.Columns.Add("NO_OF_YEARS_INSURED",typeof(int));
		...
		/// <summary>
		/// model for database field YEARS_INSU(int)
		/// </summary>
		...
		// model for database field DOG_SURCHARGE(string)
		public string DOG_SURCHARGE
		{
			get
			{
				return base.dtModel.Rows[0]["DOG_SURCHARGE"] == DBNull.Value ? Convert.ToString(null) : base.dtModel.Rows[0]["DOG_SURCHARGE"].ToString();
			}
			set
			{
				base.dtModel.Rows[0]["DOG_SURCHARGE"] = value;
			}
		}
		// model for database field IS_LOSS_FREE_12_MONTHS(string) Added on 25 jan 2006
		public string IS_LOSS_FREE_12_MONTHS
		{
			get
			{
				return base.dtModel.Rows[0]["IS_LOSS_FREE_12_MONTHS"] == DBNull.Value ? Convert.ToString(null) : base.dtModel.Rows[0]["IS_LOSS_FREE_12_MONTHS"].ToString();
			}
			set
			{
				base.dtModel.Rows[0]["IS_LOSS_FREE_12_MONTHS"] = value;
			}
		}
		// model for database field EXP_AGE_CREDIT(int) Added on 25 jan 2006
		public int EXP_AGE_CREDIT
		{
			get
			{
				return base.dtModel.Rows[0]["EXP_AGE_CREDIT"] == DBNull.Value ? Convert.ToInt32(null) : int.Parse(base.dtModel.Rows[0]["EXP_AGE_CREDIT"].ToString());
			}
			set
			{
				base.dtModel.Rows[0]["EXP_AGE_CREDIT"] = value;
			}
		}
		//Model for No of years :  9 feb 2006
		public int NO_OF_YEARS_INSURED
		{
			get
			{
				return base.dtModel.Rows[0]["NO_OF_YEARS_INSURED"] == DBNull.Value ? Convert.ToInt32(null) : int.Parse(base.dtModel.Rows[0]["NO_OF_YEARS_INSURED"].ToString());
			}
			set
			{
				base.dtModel.Rows[0]["NO_OF_YEARS_INSURED"] = value;
			}
		}
		//End No of years
...
//		}
		...
		public string MODULAR_MANUFACTURED_HOME
		{
			get
			{
				return base.dtModel.Rows[0]["MODULAR_MANUFACTURED_HOME"] == DBNull.Value ? Convert.ToString(null) : base.dtModel.Rows[0]["MODULAR_MANUFACTURED_HOME"].ToString();
			}
			set
			{
				base.dtModel.Rows[0]["MODULAR_MANUFACTURED_HOME"] = value;
			}
		}
		...
		public string VALUED_CUSTOMER_DISCOUNT_OVERRIDE
		{
			get
			{
				return base.dtModel.Rows[0]["VALUED_CUSTOMER_DISCOUNT_OVERRIDE"] == DBNull.Value ? Convert.ToString(null) : base.dtModel.Rows[0]["VALUED_CUSTOMER_DISCOUNT_OVERRIDE"].ToString();
			}
			set
			{
				base.dtModel.Rows[0]["VALUED_CUSTOMER_DISCOUNT_OVERRIDE"] = value;
			}
		}
		...
		public string VALUED_CUSTOMER_DISCOUNT_OVERRIDE_DESC
		{
			get
			{
				return base.dtModel.Rows[0]["VALUED_CUSTOMER_DISCOUNT_OVERRIDE_DESC"] == DBNull.Value ? Convert.ToString(null) : base.dtModel.Rows[0]["VALUED_CUSTOMER_DISCOUNT_OVERRIDE_DESC"].ToString();
			}
			set
			{
				base.dtModel.Rows[0]["VALUED_CUSTOMER_DISCOUNT_OVERRIDE_DESC"] = value;
			}
		}
		...
		public string BUILT_ON_CONTINUOUS_FOUNDATION
		{
			get
			{
				return base.dtModel.Rows[0]["BUILT_ON_CONTINUOUS_FOUNDATION"] == DBNull.Value ? Convert.ToString(null) : base.dtModel.Rows[0]["BUILT_ON_CONTINUOUS_FOUNDATION"].ToString();
			}
			set
			{
				base.dtModel.Rows[0]["BUILT_ON_CONTINUOUS_FOUNDATION"] = value;
			}
		}
