/******************************************************************************************
<Author				: -   Vijay Joshi
<Start Date				: -	5/19/2005 3:33:58 PM
<End Date				: -	
<Description				: - 	Model class for personal item general information.
<Review Date				: - 
<Reviewed By			: - 	
...
namespace Cms.Model.Application.HomeOwners
{
	...
	/// </summary>
	public class ClsPersArticleGenInfo : Cms.Model.ClsCommonModel
	{
		private const string APP_HOME_OWNER_PER_ART_GEN_INFO = "APP_HOME_OWNER_PER_ART_GEN_INFO";
		public ClsPersArticleGenInfo()
		{
