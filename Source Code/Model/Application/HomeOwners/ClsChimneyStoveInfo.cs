/******************************************************************************************
<Author				: -   Anshuman
<Start Date				: -	5/20/2005 4:27:30 PM
<End Date				: -	
<Description				: - 	
<Review Date				: - 
<Reviewed By			: - 	
...
{
	/// <summary>
	/// Database Model for APP_HOME_OWNER_CHIMNEY_STOVE.
	/// </summary>
	public class ClsChimneyStoveInfo : Cms.Model.ClsBaseModel
	{
		private const string APP_HOME_OWNER_CHIMNEY_STOVE = "APP_HOME_OWNER_CHIMNEY_STOVE";
		public ClsChimneyStoveInfo()
		{
			base.dtModel.TableName = "APP_HOME_OWNER_CHIMNEY_STOVE";		// setting table name for data table that holds property values.
		...
		public string IS_STOVE_VENTED
		{
			get
			{
				return base.dtModel.Rows[0]["IS_STOVE_VENTED"] == DBNull.Value ? Convert.ToString(null) : base.dtModel.Rows[0]["IS_STOVE_VENTED"].ToString();
			}
			set
			{
		...
		public string OTHER_DEVICES_ATTACHED
		{
			get
			{
				return base.dtModel.Rows[0]["OTHER_DEVICES_ATTACHED"] == DBNull.Value ? Convert.ToString(null) : base.dtModel.Rows[0]["OTHER_DEVICES_ATTACHED"].ToString();
			}
			set
			{
		...
		public string CHIMNEY_CONSTRUCTION
		{
			get
			{
				return base.dtModel.Rows[0]["CHIMNEY_CONSTRUCTION"] == DBNull.Value ? Convert.ToString(null) : base.dtModel.Rows[0]["CHIMNEY_CONSTRUCTION"].ToString();
			}
			set
			{
		...
		public string CONSTRUCT_OTHER_DESC
		{
			get
			{
				return base.dtModel.Rows[0]["CONSTRUCT_OTHER_DESC"] == DBNull.Value ? Convert.ToString(null) : base.dtModel.Rows[0]["CONSTRUCT_OTHER_DESC"].ToString();
			}
			set
			{
		...
		public string IS_TILE_FLUE_LINING
		{
			get
			{
				return base.dtModel.Rows[0]["IS_TILE_FLUE_LINING"] == DBNull.Value ? Convert.ToString(null) : base.dtModel.Rows[0]["IS_TILE_FLUE_LINING"].ToString();
			}
			set
			{
		...
		public string IS_CHIMNEY_GROUND_UP
		{
			get
			{
				return base.dtModel.Rows[0]["IS_CHIMNEY_GROUND_UP"] == DBNull.Value ? Convert.ToString(null) : base.dtModel.Rows[0]["IS_CHIMNEY_GROUND_UP"].ToString();
			}
			set
			{
		...
		public string CHIMNEY_INST_AFTER_HOUSE_BLT
		{
			get
			{
				return base.dtModel.Rows[0]["CHIMNEY_INST_AFTER_HOUSE_BLT"] == DBNull.Value ? Convert.ToString(null) : base.dtModel.Rows[0]["CHIMNEY_INST_AFTER_HOUSE_BLT"].ToString();
			}
			set
			{
		...
		public string IS_CHIMNEY_COVERED
		{
			get
			{
				return base.dtModel.Rows[0]["IS_CHIMNEY_COVERED"] == DBNull.Value ? Convert.ToString(null) : base.dtModel.Rows[0]["IS_CHIMNEY_COVERED"].ToString();
			}
			set
			{
		...
		public string THIMBLE_OR_MATERIAL
		{
			get
			{
				return base.dtModel.Rows[0]["THIMBLE_OR_MATERIAL"] == DBNull.Value ? Convert.ToString(null) : base.dtModel.Rows[0]["THIMBLE_OR_MATERIAL"].ToString();
			}
			set
			{
		...
		public string STOVE_PIPE_IS
		{
			get
			{
				return base.dtModel.Rows[0]["STOVE_PIPE_IS"] == DBNull.Value ? Convert.ToString(null) : base.dtModel.Rows[0]["STOVE_PIPE_IS"].ToString();
			}
			set
			{
		...
		public string DOES_SMOKE_PIPE_FIT
		{
			get
			{
				return base.dtModel.Rows[0]["DOES_SMOKE_PIPE_FIT"] == DBNull.Value ? Convert.ToString(null) : base.dtModel.Rows[0]["DOES_SMOKE_PIPE_FIT"].ToString();
			}
			set
			{
		...
		public string SMOKE_PIPE_WASTE_HEAT
		{
			get
			{
				return base.dtModel.Rows[0]["SMOKE_PIPE_WASTE_HEAT"] == DBNull.Value ? Convert.ToString(null) : base.dtModel.Rows[0]["SMOKE_PIPE_WASTE_HEAT"].ToString();
			}
			set
			{
		...
		public string STOVE_CONN_SECURE
		{
			get
			{
				return base.dtModel.Rows[0]["STOVE_CONN_SECURE"] == DBNull.Value ? Convert.ToString(null) : base.dtModel.Rows[0]["STOVE_CONN_SECURE"].ToString();
			}
			set
			{
		...
		public string SMOKE_PIPE_PASS
		{
			get
			{
				return base.dtModel.Rows[0]["SMOKE_PIPE_PASS"] == DBNull.Value ? Convert.ToString(null) : base.dtModel.Rows[0]["SMOKE_PIPE_PASS"].ToString();
			}
			set
			{
		...
		public string SELECT_PASS
		{
			get
			{
				return base.dtModel.Rows[0]["SELECT_PASS"] == DBNull.Value ? Convert.ToString(null) : base.dtModel.Rows[0]["SELECT_PASS"].ToString();
			}
			set
			{
