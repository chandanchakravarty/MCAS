...
namespace Cms.Model.Application.HomeOwners
{
	...
	/// </summary>
	public class ClsDwellingSectionCoveragesInfo : Cms.Model.ClsCommonModel
	{
		public ClsDwellingSectionCoveragesInfo()
		{
			//
		...
		public string COV_DESC
		{
			get
			{
				return base.dtModel.Rows[0]["COV_DESC"] == DBNull.Value ? Convert.ToString(null) : base.dtModel.Rows[0]["COVERAGE_DESC"].ToString();
			}
			set
			{
