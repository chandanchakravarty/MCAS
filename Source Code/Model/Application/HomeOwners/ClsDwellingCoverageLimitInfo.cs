/******************************************************************************************
<Author				: -   Mohit Gupta
<Start Date				: -	6/7/2005 3:14:03 PM
<End Date				: -	
<Description				: - 	
<Review Date				: - 
<Reviewed By			: - 	
...
{
	/// <summary>
	/// Summary description for ClsDwellingCoverageLimitInfo.
	/// </summary>
	public class ClsDwellingCoverageLimitInfo : Cms.Model.ClsCommonModel
	{
		public ClsDwellingCoverageLimitInfo()
		{
			base.dtModel.TableName = "APP_DWELLING_COVERAGE";		// setting table name for data table that holds property values.
