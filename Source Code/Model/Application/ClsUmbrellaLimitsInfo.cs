/******************************************************************************************
<Author					: - Pradeep Iyer
<Start Date				: -	5/26/2005 9:54:33 AM
<End Date				: -	
<Description			: - Model class for APP_UMBRELLA_LIMITS
<Review Date			: - 
<Reviewed By			: - 	
...
{
	/// <summary>
	/// Database Model for APP_UMBRELLA_LIMITS.
	/// </summary>
	public class ClsUmbrellaLimitsInfo : Cms.Model.ClsCommonModel
	{
		private const string APP_UMBRELLA_LIMITS = "APP_UMBRELLA_LIMITS";

		public ClsUmbrellaLimitsInfo()
		{
			base.dtModel.TableName = "APP_UMBRELLA_LIMITS";		// setting table name for data table that holds property values.
