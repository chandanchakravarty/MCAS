/******************************************************************************************
<Author				: -   Priya
<Start Date				: -	5/25/2005 3:53:28 PM
<End Date				: -	
<Description				: - 	
<Review Date				: - 
<Reviewed By			: - 	
...
{
	/// <summary>
	/// Database Model for APP_UMBRELLA_REAL_ESTATE_LOCATION.
	/// </summary>
	public class ClsRealEstateLocationInfo : Cms.Model.ClsCommonModel
	{
		...
		{
			base.dtModel.TableName = "APP_UMBRELLA_REAL_ESTATE_LOCATION";		// setting table name for data table that holds property values.
			this.AddColumns();								// add columns of the database table APP_UMBRELLA_REAL_ESTATE_LOCATION
