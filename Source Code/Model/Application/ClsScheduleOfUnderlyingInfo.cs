...
<End Date				: -	
<Description			: -   Models APP_UMBRELLA_UMDERLYING_POLICIES
<Review Date			: - 
<Reviewed By			: - 	
...
namespace Cms.Model.Application
{
	...
	/// </summary>
	public class ScheduleOfUnderlyingInfo : Cms.Model.ClsCommonModel
	{
		public ScheduleOfUnderlyingInfo()
		{
			base.dtModel.TableName ="APP_UMBRELLA_UNDERLYING_POLICIES";
			this.AddColumns ();
		...
		private void AddColumns()
		{
			...
			base.dtModel.Columns.Add("UNDERLYING_POL_ID",typeof(string));
		...
		// model for database field UNDERLYING_POL_ID(string)
		public string UNDERLYING_POL_ID
		{
			get
			{
				return base.dtModel.Rows[0]["UNDERLYING_POL_ID"] == DBNull.Value ? Convert.ToString(null) : base.dtModel.Rows[0]["UNDERLYING_POL_ID"].ToString();
			}
			set
			{
				base.dtModel.Rows[0]["UNDERLYING_POL_ID"] = value;
			}
		}
