...
<End Date				: -	
<Description			: -   Models APP_UMBRELLA_RATING_INFO
<Review Date			: - 
<Reviewed By			: - 	
...
{
	/// <summary>
	/// Database Model For APP_UMBRELLA_RATING_INFO
	/// </summary>
	public class ClsUmbrellaRatingInfo :Cms.Model.ClsCommonModel
	{
		public ClsUmbrellaRatingInfo()
		{
			base.dtModel.TableName ="APP_UMBRELLA_RATING_INFO";
			this.AddColumns ();
