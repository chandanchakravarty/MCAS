...
/****** Object:  StoredProcedure [dbo].[Proc_GetClaimRuleXML]    Script Date: 02/11/2015 11:59:25 ******/
SET ANSI_NULLS ON
GO
...
*/                                                                                           
CREATE proc [dbo].[Proc_GetClaimRuleXML]                                                                                                                                               
(         
...
Select ClaimantName,ClaimantNRICPPNO,ClaimantType,ClaimantAddress1,ClaimantAddress2,ClaimantAddress3,PostalCode,ClaimantContactNo,VehicleRegnNo,ClaimType,ClaimRecordNo,isnull(convert(varchar,TimeBarDate),'') as TimeBarDate,isnull(convert(varchar,ClaimDate),'') as ClaimDate,ClaimOfficer,AccidentCause,CaseCategory,ClaimantStatus,CaseStatus  
