IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[Proc_GetCLM_PaymentList]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[Proc_GetCLM_PaymentList]
GO

CREATE PROC [dbo].[Proc_GetCLM_PaymentList] (@AccidentId nvarchar(100))      
AS      
SET FMTONLY OFF;      
