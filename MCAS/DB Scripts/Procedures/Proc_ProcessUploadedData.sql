...
/****** Object:  StoredProcedure [dbo].[Proc_ProcessUploadedData]    Script Date: 02/26/2015 14:37:20 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[Proc_ProcessUploadedData]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[Proc_ProcessUploadedData]
GO
...
--begin tran
--drop proc [Proc_ProcessUploadedData]
--GO

/*************************
Created by: Pravesh K Chandel
Created Date: 23 Feb 2015
Purpose	: Process uploaded CSV Files Data which has been processed
drop proc [Proc_ProcessUploadedData]
**************************/
