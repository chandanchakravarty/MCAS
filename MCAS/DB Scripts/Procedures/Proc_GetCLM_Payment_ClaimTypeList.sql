IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[Proc_GetCLM_Payment_ClaimTypeList]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[Proc_GetCLM_Payment_ClaimTypeList]
GO
