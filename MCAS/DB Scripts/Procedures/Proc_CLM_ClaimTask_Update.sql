...
/****** Object:  StoredProcedure [dbo].[Proc_CLM_ClaimTask_Update]    Script Date: 09/02/2014 11:31:59 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[Proc_CLM_ClaimTask_Update]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[Proc_CLM_ClaimTask_Update]
GO
...
CREATE PROCEDURE [dbo].[Proc_CLM_ClaimTask_Update] @p_Id int,
@p_TaskNo int,
@p_ClaimID int,
