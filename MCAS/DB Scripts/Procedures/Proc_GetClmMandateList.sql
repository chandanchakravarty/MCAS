IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[Proc_GetClmMandateList]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[Proc_GetClmMandateList]
GO

CREATE Proc [dbo].[Proc_GetClmMandateList]    
(    
