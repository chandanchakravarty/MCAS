CREATE PROCEDURE [dbo].[Proc_GetCLM_ClaimListCrTx]
	@AccidentId [nvarchar](100)
WITH EXECUTE AS CALLER
AS
BEGIN
SET FMTONLY OFF;
select row_number() over(partition by ClaimType order by ClaimID) as RecordNumber,ClaimRecordNo,PolicyId,AccidentClaimId,ClaimID,TPVehicleNo,
