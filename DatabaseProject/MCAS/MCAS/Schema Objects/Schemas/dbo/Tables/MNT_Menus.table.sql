CREATE TABLE [dbo].[MNT_Menus](
	...
	[VirtualSource] [varchar](100) COLLATE SQL_Latin1_General_CP1_CI_AS NULL CONSTRAINT [DF_TM_Menus_VirtualSource]  DEFAULT ((1)),
	...
	[LangId] [int] NULL,
	[IsActive] [varchar](1) COLLATE SQL_Latin1_General_CP1_CI_AS NULL CONSTRAINT [DF_MNT_Menus_IsExists]  DEFAULT ('Y'),
	[GroupType] [char](1) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
 CONSTRAINT [PK_TM_Menus] PRIMARY KEY CLUSTERED 
 (
	[MenuId] ASC
