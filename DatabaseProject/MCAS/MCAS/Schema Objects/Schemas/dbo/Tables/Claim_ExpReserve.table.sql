CREATE TABLE [dbo].[Claim_ExpReserve](
	...
	[RES_NewLoc] [decimal](18, 2) NULL CONSTRAINT [DF_Claim_ExpReserve_RES_NewLoc]  DEFAULT ((0)),
	[RES_NewFor] [decimal](18, 2) NULL CONSTRAINT [DF_Claim_ExpReserve_RES_NewFor]  DEFAULT ((0)),
