CREATE TABLE [dbo].[Claim_ExpReserve_Log](
	[ClaimRefNo] [nvarchar](21) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	...
	[RES_NewLoc] [decimal](18, 2) NULL CONSTRAINT [DF_Claim_ExpReserve_Log_RES_NewLoc]  DEFAULT ((0)),
	[RES_NewFor] [decimal](18, 2) NULL CONSTRAINT [DF_Claim_ExpReserve_Log_RES_NewFor]  DEFAULT ((0)),
	[DispExpCode] [nvarchar](20) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	[ClaimantRefNo] [nvarchar](20) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	[DispExpNo] [int] NULL
)
